...
`)}const wl=new Fe;function op(i){Ze._getMatrix(wl,Ze.workingColorSpace,i);const e=`mat3( ${wl.elements.map(t=>t.toFixed(4))} )`;switch(Ze.getTransfer(i)){case ji:return[e,"LinearTransferOETF"];case it:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Rl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const cp={[ja]:"Linear",[eo]:"Reinhard",[to]:"Cineon",[no]:"ACESFilmic",[ro]:"AgX",[so]:"Neutral",[io]:"Custom"};function up(i,e){const t=cp[e];return t===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ur=new U;function hp(){Ze.getLuminanceCoefficients(Ur);const i=Ur.x.toFixed(4),e=Ur.y.toFixed(4),t=Ur.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,qp=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],Yp=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],Fl=new ht,Gi=new U,Ia=new U;function $p(i,e,t){let n=new Ma;const r=new Ne,s=new Ne,a=new ft,o=new Uu,c=new Nu,l={},h=t.maxTextureSize,p={[en]:Lt,[Lt]:en,[Ht]:Ht},u=new on({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ne},radius:{value:4}},vertexShader:Wp,fragmentShader:Xp}),d=u.clone();d.defines.HORIZONTAL_PASS=1;const _=new wt;_.setAttribute("position",new gt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new qt(_,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ki;let f=this.type;this.render=function(b,R,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===Ec&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ki);const y=i.getRenderTarget(),D=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),L=i.state;L.setBlending(pn),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const H=f!==this.type;H&&R.traverse(function($){$.material&&(Array.isArray($.material)?$.material.forEach(O=>O.needsUpdate=!0):$.material.needsUpdate=!0)});for(let $=0,O=b.length;$<O;$++){const q=b[$],V=q.shadow;if(V===void 0){De("WebGLShadowMap:",q,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const W=V.getFrameExtents();r.multiply(W),s.copy(V.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/W.x),r.x=s.x*W.x,V.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/W.y),r.y=s.y*W.y,V.mapSize.y=s.y));const J=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=J,V.map===null||H===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===yi){if(q.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new an(r.x,r.y,{format:Hn,type:mn,minFilter:vt,magFilter:vt,generateMipmaps:!1}),V.map.texture.name=q.name+".shadowMap",V.map.depthTexture=new pi(r.x,r.y,rn),V.map.depthTexture.name=q.name+".shadowMapDepth",V.map.depthTexture.format=gn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=At,V.map.depthTexture.magFilter=At}else q.isPointLight?(V.map=new ml(r.x),V.map.depthTexture=new wu(r.x,nn)):(V.map=new an(r.x,r.y),V.map.depthTexture=new pi(r.x,r.y,nn)),V.map.depthTexture.name=q.name+".shadowMap",V.map.depthTexture.format=gn,this.type===ki?(V.map.depthTexture.compareFunction=J?qs:Xs,V.map.depthTexture.minFilter=vt,V.map.depthTexture.magFilter=vt):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=At,V.map.depthTexture.magFilter=At);V.camera.updateProjectionMatrix()}const j=V.map.isWebGLCubeRenderTarget?6:1;for(let ie=0;ie<j;ie++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,ie),i.clear();else{ie===0&&(i.setRenderTarget(V.map),i.clear());const _e=V.getViewport(ie);a.set(s.x*_e.x,s.y*_e.y,s.x*_e.z,s.y*_e.w),L.viewport(a)}if(q.isPointLight){const _e=V.camera,ze=V.matrix,nt=q.distance||_e.far;nt!==_e.far&&(_e.far=nt,_e.updateProjectionMatrix()),Gi.setFromMatrixPosition(q.matrixWorld),_e.position.copy(Gi),Ia.copy(_e.position),Ia.add(qp[ie]),_e.up.copy(Yp[ie]),_e.lookAt(Ia),_e.updateMatrixWorld(),ze.makeTranslation(-Gi.x,-Gi.y,-Gi.z),Fl.multiplyMatrices(_e.projectionMatrix,_e.matrixWorldInverse),V._frustum.setFromProjectionMatrix(Fl,_e.coordinateSystem,_e.reversedDepth)}else V.updateMatrices(q);n=V.getFrustum(),S(R,x,V.camera,q,this.type)}V.isPointLightShadow!==!0&&this.type===yi&&A(V,x),V.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(y,D,C)};function A(b,R){const x=e.update(M);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,d.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new an(r.x,r.y,{format:Hn,type:mn})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(R,null,x,u,M,null),d.uniforms.shadow_pass.value=b.mapPass.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(R,null,x,d,M,null)}function w(b,R,x,y){let D=null;const C=x.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)D=C;else if(D=x.isPointLight===!0?c:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const L=D.uuid,H=R.uuid;let $=l[L];$===void 0&&($={},l[L]=$);let O=$[H];O===void 0&&(O=D.clone(),$[H]=O,R.addEventListener("dispose",T)),D=O}if(D.visible=R.visible,D.wireframe=R.wireframe,y===yi?D.side=R.shadowSide!==null?R.shadowSide:R.side:D.side=R.shadowSide!==null?R.shadowSide:p[R.side],D.alphaMap=R.alphaMap,D.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,D.map=R.map,D.clipShadows=R.clipShadows,D.clippingPlanes=R.clippingPlanes,D.clipIntersection=R.clipIntersection,D.displacementMap=R.displacementMap,D.displacementScale=R.displacementScale,D.displacementBias=R.displacementBias,D.wireframeLinewidth=R.wireframeLinewidth,D.linewidth=R.linewidth,x.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const L=i.properties.get(D);L.light=x}return D}function S(b,R,x,y,D){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&D===yi)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,b.matrixWorld);const H=e.update(b),$=b.material;if(Array.isArray($)){const O=H.groups;for(let q=0,V=O.length;q<V;q++){const W=O[q],J=$[W.materialIndex];if(J&&J.visible){const j=w(b,J,y,D);b.onBeforeShadow(i,b,R,x,H,j,W),i.renderBufferDirect(x,null,H,j,b,W),b.onAfterShadow(i,b,R,x,H,j,W)}}}else if($.visible){const O=w(b,$,y,D);b.onBeforeShadow(i,b,R,x,H,O,null),i.renderBufferDirect(x,null,H,O,b,null),b.onAfterShadow(i,b,R,x,H,O,null)}}const L=b.children;for(let H=0,$=L.length;H<$;H++)S(L[H],R,x,y,D)}function T(b){b.target.removeEventListener("dispose",T);for(const x in l){const y=l[x],D=b.target.uuid;D in y&&(y[D].dispose(),delete y[D])}}}function Kp(i,e){function t(){let I=!1;const ce=new ft;let Q=null;const he=new ft(0,0,0,0);return{setMask:function(ge){Q!==ge&&!I&&(i.colorMask(ge,ge,ge,ge),Q=ge)},setLocked:function(ge){I=ge},setClear:function(ge,ee,ye,Se,pt){pt===!0&&(ge*=Se,ee*=Se,ye*=Se),ce.set(ge,ee,ye,Se),he.equals(ce)===!1&&(i.clearColor(ge,ee,ye,Se),he.copy(ce))},reset:function(){I=!1,Q=null,he.set(-1,0,0,0)}}}function n(){let I=!1,ce=!1,Q=null,he=null,ge=null;return{setReversed:function(ee){if(ce!==ee){const ye=e.get("EXT_clip_control");ee?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),ce=ee;const Se=ge;ge=null,this.setClear(Se)}},getReversed:function(){return ce},setTest:function(ee){ee?ne(i.DEPTH_TEST):be(i.DEPTH_TEST)},setMask:function(ee){Q!==ee&&!I&&(i.depthMask(ee),Q=ee)},setFunc:function(ee){if(ce&&(ee=tu[ee]),he!==ee){switch(ee){case Kr:i.depthFunc(i.NEVER);break;case Zr:i.depthFunc(i.ALWAYS);break;case Jr:i.depthFunc(i.LESS);break;case jn:i.depthFunc(i.LEQUAL);break;case Qr:i.depthFunc(i.EQUAL);break;case jr:i.depthFunc(i.GEQUAL);break;case es:i.depthFunc(i.GREATER);break;case ts:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}he=ee}},setLocked:function(ee){I=ee},setClear:function(ee){ge!==ee&&(ge=ee,ce&&(ee=1-ee),i.clearDepth(ee))},reset:function(){I=!1,Q=null,he=null,ge=null,ce=!1}}}function r(){let I=!1,ce=null,Q=null,he=null,ge=null,ee=null,ye=null,Se=null,pt=null;return{setTest:function(lt){I||(lt?ne(i.STENCIL_TEST):be(i.STENCIL_TEST))},setMask:function(lt){ce!==lt&&!I&&(i.stencilMask(lt),ce=lt)},setFunc:function(lt,hn,fn){(Q!==lt||he!==hn||ge!==fn)&&(i.stencilFunc(lt,hn,fn),Q=lt,he=hn,ge=fn)},setOp:function(lt,hn,fn){(ee!==lt||ye!==hn||Se!==fn)&&(i.stencilOp(lt,hn,fn),ee=lt,ye=hn,Se=fn)},setLocked:function(lt){I=lt},setClear:function(lt){pt!==lt&&(i.clearStencil(lt),pt=lt)},reset:function(){I=!1,ce=null,Q=null,he=null,ge=null,ee=null,ye=null,Se=null,pt=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let h={},p={},u={},d=new WeakMap,_=[],M=null,m=!1,f=null,A=null,w=null,S=null,T=null,b=null,R=null,x=new Xe(0,0,0),y=0,D=!1,C=null,L=null,H=null,$=null,O=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,W=0;const J=i.getParameter(i.VERSION);J.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(J)[1]),V=W>=1):J.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),V=W>=2);let j=null,ie={};const _e=i.getParameter(i.SCISSOR_BOX),ze=i.getParameter(i.VIEWPORT),nt=new ft().fromArray(_e),qe=new ft().fromArray(ze);function Z(I,ce,Q,he){const ge=new Uint8Array(4),ee=i.createTexture();i.bindTexture(I,ee),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ye=0;ye<Q;ye++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(ce,0,i.RGBA,1,1,he,0,i.RGBA,i.UNSIGNED_BYTE,ge):i.texImage2D(ce+ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ge);return ee}const se={};se[i.TEXTURE_2D]=Z(i.TEXTURE_2D,i.TEXTURE_2D,1),se[i.TEXTURE_CUBE_MAP]=Z(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),se[i.TEXTURE_2D_ARRAY]=Z(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),se[i.TEXTURE_3D]=Z(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ne(i.DEPTH_TEST),a.setFunc(jn),dt(!1),le($a),ne(i.CULL_FACE),Je(pn);function ne(I){h[I]!==!0&&(i.enable(I),h[I]=!0)}function be(I){h[I]!==!1&&(i.disable(I),h[I]=!1)}function Ie(I,ce){return u[I]!==ce?(i.bindFramebuffer(I,ce),u[I]=ce,I===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ce),I===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ce),!0):!1}function Me(I,ce){let Q=_,he=!1;if(I){Q=d.get(ce),Q===void 0&&(Q=[],d.set(ce,Q));const ge=I.textures;if(Q.length!==ge.length||Q[0]!==i.COLOR_ATTACHMENT0){for(let ee=0,ye=ge.length;ee<ye;ee++)Q[ee]=i.COLOR_ATTACHMENT0+ee;Q.length=ge.length,he=!0}}else Q[0]!==i.BACK&&(Q[0]=i.BACK,he=!0);he&&i.drawBuffers(Q)}function ut(I){return M!==I?(i.useProgram(I),M=I,!0):!1}const He={[Bn]:i.FUNC_ADD,[bc]:i.FUNC_SUBTRACT,[Tc]:i.FUNC_REVERSE_SUBTRACT};He[Ac]=i.MIN,He[wc]=i.MAX;const tt={[Rc]:i.ZERO,[Cc]:i.ONE,[Pc]:i.SRC_COLOR,[Yr]:i.SRC_ALPHA,[Fc]:i.SRC_ALPHA_SATURATE,[Uc]:i.DST_COLOR,[Lc]:i.DST_ALPHA,[Dc]:i.ONE_MINUS_SRC_COLOR,[$r]:i.ONE_MINUS_SRC_ALPHA,[Nc]:i.ONE_MINUS_DST_COLOR,[Ic]:i.ONE_MINUS_DST_ALPHA,[Oc]:i.CONSTANT_COLOR,[Bc]:i.ONE_MINUS_CONSTANT_COLOR,[zc]:i.CONSTANT_ALPHA,[Gc]:i.ONE_MINUS_CONSTANT_ALPHA};function Je(I,ce,Q,he,ge,ee,ye,Se,pt,lt){if(I===pn){m===!0&&(be(i.BLEND),m=!1);return}if(m===!1&&(ne(i.BLEND),m=!0),I!==yc){if(I!==f||lt!==D){if((A!==Bn||T!==Bn)&&(i.blendEquation(i.FUNC_ADD),A=Bn,T=Bn),lt)switch(I){case Qn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ka:i.blendFunc(i.ONE,i.ONE);break;case Za:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ja:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Qe("WebGLState: Invalid blending: ",I);break}else switch(I){case Qn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ka:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Za:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ja:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",I);break}w=null,S=null,b=null,R=null,x.set(0,0,0),y=0,f=I,D=lt}return}ge=ge||ce,ee=ee||Q,ye=ye||he,(ce!==A||ge!==T)&&(i.blendEquationSeparate(He[ce],He[ge]),A=ce,T=ge),(Q!==w||he!==S||ee!==b||ye!==R)&&(i.blendFuncSeparate(tt[Q],tt[he],tt[ee],tt[ye]),w=Q,S=he,b=ee,R=ye),(Se.equals(x)===!1||pt!==y)&&(i.blendColor(Se.r,Se.g,Se.b,pt),x.copy(Se),y=pt),f=I,D=!1}function Ue(I,ce){I.side===Ht?be(i.CULL_FACE):ne(i.CULL_FACE);let Q=I.side===Lt;ce&&(Q=!Q),dt(Q),I.blending===Qn&&I.transparent===!1?Je(pn):Je(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const he=I.stencilWrite;o.setTest(he),he&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),ke(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ne(i.SAMPLE_ALPHA_TO_COVERAGE):be(i.SAMPLE_ALPHA_TO_COVERAGE)}function dt(I){C!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),C=I)}function le(I){I!==Mc?(ne(i.CULL_FACE),I!==L&&(I===$a?i.cullFace(i.BACK):I===Sc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):be(i.CULL_FACE),L=I}function we(I){I!==H&&(V&&i.lineWidth(I),H=I)}function ke(I,ce,Q){I?(ne(i.POLYGON_OFFSET_FILL),($!==ce||O!==Q)&&($=ce,O=Q,a.getReversed()&&(ce=-ce),i.polygonOffset(ce,Q))):be(i.POLYGON_OFFSET_FILL)}function Ge(I){I?ne(i.SCISSOR_TEST):be(i.SCISSOR_TEST)}function je(I){I===void 0&&(I=i.TEXTURE0+q-1),j!==I&&(i.activeTexture(I),j=I)}function P(I,ce,Q){Q===void 0&&(j===null?Q=i.TEXTURE0+q-1:Q=j);let he=ie[Q];he===void 0&&(he={type:void 0,texture:void 0},ie[Q]=he),(he.type!==I||he.texture!==ce)&&(j!==Q&&(i.activeTexture(Q),j=Q),i.bindTexture(I,ce||se[I]),he.type=I,he.texture=ce)}function We(){const I=ie[j];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function Ke(){try{i.compressedTexImage2D(...arguments)}catch(I){Qe("WebGLState:",I)}}function E(){try{i.compressedTexImage3D(...arguments)}catch(I){Qe("WebGLState:",I)}}function g(){try{i.texSubImage2D(...arguments)}catch(I){Qe("WebGLState:",I)}}function F(){try{i.texSubImage3D(...arguments)}catch(I){Qe("WebGLState:",I)}}function G(){try{i.compressedTexSubImage2D(...arguments)}catch(I){Qe("WebGLState:",I)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(I){Qe("WebGLState:",I)}}function re(){try{i.texStorage2D(...arguments)}catch(I){Qe("WebGLState:",I)}}function ae(){try{i.texStorage3D(...arguments)}catch(I){Qe("WebGLState:",I)}}function X(){try{i.texImage2D(...arguments)}catch(I){Qe("WebGLState:",I)}}function K(){try{i.texImage3D(...arguments)}catch(I){Qe("WebGLState:",I)}}function oe(I){return p[I]!==void 0?p[I]:i.getParameter(I)}function Te(I,ce){p[I]!==ce&&(i.pixelStorei(I,ce),p[I]=ce)}function de(I){nt.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),nt.copy(I))}function ue(I){qe.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),qe.copy(I))}function Ce(I,ce){let Q=l.get(ce);Q===void 0&&(Q=new WeakMap,l.set(ce,Q));let he=Q.get(I);he===void 0&&(he=i.getUniformBlockIndex(ce,I.name),Q.set(I,he))}function Le(I,ce){const he=l.get(ce).get(I);c.get(ce)!==he&&(i.uniformBlockBinding(ce,he,I.__bindingPointIndex),c.set(ce,he))}function Oe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},p={},j=null,ie={},u={},d=new WeakMap,_=[],M=null,m=!1,f=null,A=null,w=null,S=null,T=null,b=null,R=null,x=new Xe(0,0,0),y=0,D=!1,C=null,L=null,H=null,$=null,O=null,nt.set(0,0,i.canvas.width,i.canvas.height),qe.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ne,disable:be,bindFramebuffer:Ie,drawBuffers:Me,useProgram:ut,setBlending:Je,setMaterial:Ue,setFlipSided:dt,setCullFace:le,setLineWidth:we,setPolygonOffset:ke,setScissorTest:Ge,activeTexture:je,bindTexture:P,unbindTexture:We,compressedTexImage2D:Ke,compressedTexImage3D:E,texImage2D:X,texImage3D:K,pixelStorei:Te,getParameter:oe,updateUBOMapping:Ce,uniformBlockBinding:Le,texStorage2D:re,texStorage3D:ae,texSubImage2D:g,texSubImage3D:F,compressedTexSubImage2D:G,compressedTexSubImage3D:Y,scissor:de,viewport:ue,reset:Oe}}function Zp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ne,h=new WeakMap,p=new Set;let u;const d=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(E,g){return _?new OffscreenCanvas(E,g):er("canvas")}function m(E,g,F){let G=1;const Y=Ke(E);if((Y.width>F||Y.height>F)&&(G=F/Math.max(Y.width,Y.height)),G<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const re=Math.floor(G*Y.width),ae=Math.floor(G*Y.height);u===void 0&&(u=M(re,ae));const X=g?M(re,ae):u;return X.width=re,X.height=ae,X.getContext("2d").drawImage(E,0,0,re,ae),De("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+re+"x"+ae+")."),X}else return"data"in E&&De("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),E;return E}function f(E){return E.generateMipmaps}function A(E){i.generateMipmap(E)}function w(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(E,g,F,G,Y,re=!1){if(E!==null){if(i[E]!==void 0)return i[E];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let ae;G&&(ae=e.get("EXT_texture_norm16"),ae||De("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=g;if(g===i.RED&&(F===i.FLOAT&&(X=i.R32F),F===i.HALF_FLOAT&&(X=i.R16F),F===i.UNSIGNED_BYTE&&(X=i.R8),F===i.UNSIGNED_SHORT&&ae&&(X=ae.R16_EXT),F===i.SHORT&&ae&&(X=ae.R16_SNORM_EXT)),g===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.R8UI),F===i.UNSIGNED_SHORT&&(X=i.R16UI),F===i.UNSIGNED_INT&&(X=i.R32UI),F===i.BYTE&&(X=i.R8I),F===i.SHORT&&(X=i.R16I),F===i.INT&&(X=i.R32I)),g===i.RG&&(F===i.FLOAT&&(X=i.RG32F),F===i.HALF_FLOAT&&(X=i.RG16F),F===i.UNSIGNED_BYTE&&(X=i.RG8),F===i.UNSIGNED_SHORT&&ae&&(X=ae.RG16_EXT),F===i.SHORT&&ae&&(X=ae.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.RG8UI),F===i.UNSIGNED_SHORT&&(X=i.RG16UI),F===i.UNSIGNED_INT&&(X=i.RG32UI),F===i.BYTE&&(X=i.RG8I),F===i.SHORT&&(X=i.RG16I),F===i.INT&&(X=i.RG32I)),g===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.RGB8UI),F===i.UNSIGNED_SHORT&&(X=i.RGB16UI),F===i.UNSIGNED_INT&&(X=i.RGB32UI),F===i.BYTE&&(X=i.RGB8I),F===i.SHORT&&(X=i.RGB16I),F===i.INT&&(X=i.RGB32I)),g===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),F===i.UNSIGNED_INT&&(X=i.RGBA32UI),F===i.BYTE&&(X=i.RGBA8I),F===i.SHORT&&(X=i.RGBA16I),F===i.INT&&(X=i.RGBA32I)),g===i.RGB&&(F===i.UNSIGNED_SHORT&&ae&&(X=ae.RGB16_EXT),F===i.SHORT&&ae&&(X=ae.RGB16_SNORM_EXT),F===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),g===i.RGBA){const K=re?ji:Ze.getTransfer(Y);F===i.FLOAT&&(X=i.RGBA32F),F===i.HALF_FLOAT&&(X=i.RGBA16F),F===i.UNSIGNED_BYTE&&(X=K===it?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT&&ae&&(X=ae.RGBA16_EXT),F===i.SHORT&&ae&&(X=ae.RGBA16_SNORM_EXT),F===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function T(E,g){let F;return E?g===null||g===nn||g===Ti?F=i.DEPTH24_STENCIL8:g===rn?F=i.DEPTH32F_STENCIL8:g===bi&&(F=i.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===nn||g===Ti?F=i.DEPTH_COMPONENT24:g===rn?F=i.DEPTH_COMPONENT32F:g===bi&&(F=i.DEPTH_COMPONENT16),F}function b(E,g){return f(E)===!0||E.isFramebufferTexture&&E.minFilter!==At&&E.minFilter!==vt?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function R(E){const g=E.target;g.removeEventListener("dispose",R),y(g),g.isVideoTexture&&h.delete(g),g.isHTMLTexture&&p.delete(g)}function x(E){const g=E.target;g.removeEventListener("dispose",x),C(g)}function y(E){const g=n.get(E);if(g.__webglInit===void 0)return;const F=E.source,G=d.get(F);if(G){const Y=G[g.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&D(E),Object.keys(G).length===0&&d.delete(F)}n.remove(E)}function D(E){const g=n.get(E);i.deleteTexture(g.__webglTexture);const F=E.source,G=d.get(F);delete G[g.__cacheKey],a.memory.textures--}function C(E){const g=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(g.__webglFramebuffer[G]))for(let Y=0;Y<g.__webglFramebuffer[G].length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[G][Y]);else i.deleteFramebuffer(g.__webglFramebuffer[G]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[G])}else{if(Array.isArray(g.__webglFramebuffer))for(let G=0;G<g.__webglFramebuffer.length;G++)i.deleteFramebuffer(g.__webglFramebuffer[G]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let G=0;G<g.__webglColorRenderbuffer.length;G++)g.__webglColorRenderbuffer[G]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[G]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=E.textures;for(let G=0,Y=F.length;G<Y;G++){const re=n.get(F[G]);re.__webglTexture&&(i.deleteTexture(re.__webglTexture),a.memory.textures--),n.remove(F[G])}n.remove(E)}let L=0;function H(){L=0}function $(){return L}function O(E){L=E}function q(){const E=L;return E>=r.maxTextures&&De("WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),L+=1,E}function V(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function W(E,g){const F=n.get(E);if(E.isVideoTexture&&P(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&F.__version!==E.version){const G=E.image;if(G===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{be(F,E,g);return}}else E.isExternalTexture&&(F.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+g)}function J(E,g){const F=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){be(F,E,g);return}else E.isExternalTexture&&(F.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+g)}function j(E,g){const F=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){be(F,E,g);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+g)}function ie(E,g){const F=n.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&F.__version!==E.version){Ie(F,E,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+g)}const _e={[rs]:i.REPEAT,[Ft]:i.CLAMP_TO_EDGE,[ss]:i.MIRRORED_REPEAT},ze={[At]:i.NEAREST,[kc]:i.NEAREST_MIPMAP_NEAREST,[Xi]:i.NEAREST_MIPMAP_LINEAR,[vt]:i.LINEAR,[as]:i.LINEAR_MIPMAP_NEAREST,[Gn]:i.LINEAR_MIPMAP_LINEAR},nt={[qc]:i.NEVER,[Jc]:i.ALWAYS,[Yc]:i.LESS,[Xs]:i.LEQUAL,[$c]:i.EQUAL,[qs]:i.GEQUAL,[Kc]:i.GREATER,[Zc]:i.NOTEQUAL};function qe(E,g){if(g.type===rn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===vt||g.magFilter===as||g.magFilter===Xi||g.magFilter===Gn||g.minFilter===vt||g.minFilter===as||g.minFilter===Xi||g.minFilter===Gn)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,_e[g.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,_e[g.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,_e[g.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,ze[g.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,ze[g.minFilter]),g.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,nt[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===At||g.minFilter!==Xi&&g.minFilter!==Gn||g.type===rn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Z(E,g){let F=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",R));const G=g.source;let Y=d.get(G);Y===void 0&&(Y={},d.set(G,Y));const re=V(g);if(re!==E.__cacheKey){Y[re]===void 0&&(Y[re]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Y[re].usedTimes++;const ae=Y[E.__cacheKey];ae!==void 0&&(Y[E.__cacheKey].usedTimes--,ae.usedTimes===0&&D(g)),E.__cacheKey=re,E.__webglTexture=Y[re].texture}return F}function se(E,g,F){return Math.floor(Math.floor(E/F)/g)}function ne(E,g,F,G){const re=E.updateRanges;if(re.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,F,G,g.data);else{re.sort((Te,de)=>Te.start-de.start);let ae=0;for(let Te=1;Te<re.length;Te++){const de=re[ae],ue=re[Te],Ce=de.start+de.count,Le=se(ue.start,g.width,4),Oe=se(de.start,g.width,4);ue.start<=Ce+1&&Le===Oe&&se(ue.start+ue.count-1,g.width,4)===Le?de.count=Math.max(de.count,ue.start+ue.count-de.start):(++ae,re[ae]=ue)}re.length=ae+1;const X=t.getParameter(i.UNPACK_ROW_LENGTH),K=t.getParameter(i.UNPACK_SKIP_PIXELS),oe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Te=0,de=re.length;Te<de;Te++){const ue=re[Te],Ce=Math.floor(ue.start/4),Le=Math.ceil(ue.count/4),Oe=Ce%g.width,I=Math.floor(Ce/g.width),ce=Le,Q=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Oe),t.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Oe,I,ce,Q,F,G,g.data)}E.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,X),t.pixelStorei(i.UNPACK_SKIP_PIXELS,K),t.pixelStorei(i.UNPACK_SKIP_ROWS,oe)}}function be(E,g,F){let G=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(G=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(G=i.TEXTURE_3D);const Y=Z(E,g),re=g.source;t.bindTexture(G,E.__webglTexture,i.TEXTURE0+F);const ae=n.get(re);if(re.version!==ae.__version||Y===!0){if(t.activeTexture(i.TEXTURE0+F),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const Q=Ze.getPrimaries(Ze.workingColorSpace),he=g.colorSpace===yn?null:Ze.getPrimaries(g.colorSpace),ge=g.colorSpace===yn||Q===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let K=m(g.image,!1,r.maxTextureSize);K=We(g,K);const oe=s.convert(g.format,g.colorSpace),Te=s.convert(g.type);let de=S(g.internalFormat,oe,Te,g.normalized,g.colorSpace,g.isVideoTexture);qe(G,g);let ue;const Ce=g.mipmaps,Le=g.isVideoTexture!==!0,Oe=ae.__version===void 0||Y===!0,I=re.dataReady,ce=b(g,K);if(g.isDepthTexture)de=T(g.format===Vn,g.type),Oe&&(Le?t.texStorage2D(i.TEXTURE_2D,1,de,K.width,K.height):t.texImage2D(i.TEXTURE_2D,0,de,K.width,K.height,0,oe,Te,null));else if(g.isDataTexture)if(Ce.length>0){Le&&Oe&&t.texStorage2D(i.TEXTURE_2D,ce,de,Ce[0].width,Ce[0].height);for(let Q=0,he=Ce.length;Q<he;Q++)ue=Ce[Q],Le?I&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ue.width,ue.height,oe,Te,ue.data):t.texImage2D(i.TEXTURE_2D,Q,de,ue.width,ue.height,0,oe,Te,ue.data);g.generateMipmaps=!1}else Le?(Oe&&t.texStorage2D(i.TEXTURE_2D,ce,de,K.width,K.height),I&&ne(g,K,oe,Te)):t.texImage2D(i.TEXTURE_2D,0,de,K.width,K.height,0,oe,Te,K.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Le&&Oe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ce,de,Ce[0].width,Ce[0].height,K.depth);for(let Q=0,he=Ce.length;Q<he;Q++)if(ue=Ce[Q],g.format!==kt)if(oe!==null)if(Le){if(I)if(g.layerUpdates.size>0){const ge=al(ue.width,ue.height,g.format,g.type);for(const ee of g.layerUpdates){const ye=ue.data.subarray(ee*ge/ue.data.BYTES_PER_ELEMENT,(ee+1)*ge/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,ee,ue.width,ue.height,1,oe,ye)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,ue.width,ue.height,K.depth,oe,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,de,ue.width,ue.height,K.depth,0,ue.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Le?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,ue.width,ue.height,K.depth,oe,Te,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,de,ue.width,ue.height,K.depth,0,oe,Te,ue.data)}else{Le&&Oe&&t.texStorage2D(i.TEXTURE_2D,ce,de,Ce[0].width,Ce[0].height);for(let Q=0,he=Ce.length;Q<he;Q++)ue=Ce[Q],g.format!==kt?oe!==null?Le?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,ue.width,ue.height,oe,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,de,ue.width,ue.height,0,ue.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Le?I&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ue.width,ue.height,oe,Te,ue.data):t.texImage2D(i.TEXTURE_2D,Q,de,ue.width,ue.height,0,oe,Te,ue.data)}else if(g.isDataArrayTexture)if(Le){if(Oe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ce,de,K.width,K.height,K.depth),I)if(g.layerUpdates.size>0){const Q=al(K.width,K.height,g.format,g.type);for(const he of g.layerUpdates){const ge=K.data.subarray(he*Q/K.data.BYTES_PER_ELEMENT,(he+1)*Q/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,he,K.width,K.height,1,oe,Te,ge)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,oe,Te,K.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,de,K.width,K.height,K.depth,0,oe,Te,K.data);else if(g.isData3DTexture)Le?(Oe&&t.texStorage3D(i.TEXTURE_3D,ce,de,K.width,K.height,K.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,oe,Te,K.data)):t.texImage3D(i.TEXTURE_3D,0,de,K.width,K.height,K.depth,0,oe,Te,K.data);else if(g.isFramebufferTexture){if(Oe)if(Le)t.texStorage2D(i.TEXTURE_2D,ce,de,K.width,K.height);else{let Q=K.width,he=K.height;for(let ge=0;ge<ce;ge++)t.texImage2D(i.TEXTURE_2D,ge,de,Q,he,0,oe,Te,null),Q>>=1,he>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const Q=i.canvas;if(Q.hasAttribute("layoutsubtree")||Q.setAttribute("layoutsubtree","true"),K.parentNode!==Q){Q.appendChild(K),p.add(g),Q.onpaint=he=>{const ge=he.changedElements;for(const ee of p)ge.includes(ee.image)&&(ee.needsUpdate=!0)},Q.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,K);else{const ge=i.RGBA,ee=i.RGBA,ye=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,ge,ee,ye,K)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ce.length>0){if(Le&&Oe){const Q=Ke(Ce[0]);t.texStorage2D(i.TEXTURE_2D,ce,de,Q.width,Q.height)}for(let Q=0,he=Ce.length;Q<he;Q++)ue=Ce[Q],Le?I&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,oe,Te,ue):t.texImage2D(i.TEXTURE_2D,Q,de,oe,Te,ue);g.generateMipmaps=!1}else if(Le){if(Oe){const Q=Ke(K);t.texStorage2D(i.TEXTURE_2D,ce,de,Q.width,Q.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,oe,Te,K)}else t.texImage2D(i.TEXTURE_2D,0,de,oe,Te,K);f(g)&&A(G),ae.__version=re.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function Ie(E,g,F){if(g.image.length!==6)return;const G=Z(E,g),Y=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+F);const re=n.get(Y);if(Y.version!==re.__version||G===!0){t.activeTexture(i.TEXTURE0+F);const ae=Ze.getPrimaries(Ze.workingColorSpace),X=g.colorSpace===yn?null:Ze.getPrimaries(g.colorSpace),K=g.colorSpace===yn||ae===X?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);const oe=g.isCompressedTexture||g.image[0].isCompressedTexture,Te=g.image[0]&&g.image[0].isDataTexture,de=[];for(let ee=0;ee<6;ee++)!oe&&!Te?de[ee]=m(g.image[ee],!0,r.maxCubemapSize):de[ee]=Te?g.image[ee].image:g.image[ee],de[ee]=We(g,de[ee]);const ue=de[0],Ce=s.convert(g.format,g.colorSpace),Le=s.convert(g.type),Oe=S(g.internalFormat,Ce,Le,g.normalized,g.colorSpace),I=g.isVideoTexture!==!0,ce=re.__version===void 0||G===!0,Q=Y.dataReady;let he=b(g,ue);qe(i.TEXTURE_CUBE_MAP,g);let ge;if(oe){I&&ce&&t.texStorage2D(i.TEXTURE_CUBE_MAP,he,Oe,ue.width,ue.height);for(let ee=0;ee<6;ee++){ge=de[ee].mipmaps;for(let ye=0;ye<ge.length;ye++){const Se=ge[ye];g.format!==kt?Ce!==null?I?Q&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye,0,0,Se.width,Se.height,Ce,Se.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye,Oe,Se.width,Se.height,0,Se.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye,0,0,Se.width,Se.height,Ce,Le,Se.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye,Oe,Se.width,Se.height,0,Ce,Le,Se.data)}}}else{if(ge=g.mipmaps,I&&ce){ge.length>0&&he++;const ee=Ke(de[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,he,Oe,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Te){I?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,de[ee].width,de[ee].height,Ce,Le,de[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Oe,de[ee].width,de[ee].height,0,Ce,Le,de[ee].data);for(let ye=0;ye<ge.length;ye++){const pt=ge[ye].image[ee].image;I?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye+1,0,0,pt.width,pt.height,Ce,Le,pt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye+1,Oe,pt.width,pt.height,0,Ce,Le,pt.data)}}else{I?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ce,Le,de[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Oe,Ce,Le,de[ee]);for(let ye=0;ye<ge.length;ye++){const Se=ge[ye];I?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye+1,0,0,Ce,Le,Se.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ye+1,Oe,Ce,Le,Se.image[ee])}}}f(g)&&A(i.TEXTURE_CUBE_MAP),re.__version=Y.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function Me(E,g,F,G,Y,re){const ae=s.convert(F.format,F.colorSpace),X=s.convert(F.type),K=S(F.internalFormat,ae,X,F.normalized,F.colorSpace),oe=n.get(g),Te=n.get(F);if(Te.__renderTarget=g,!oe.__hasExternalTextures){const de=Math.max(1,g.width>>re),ue=Math.max(1,g.height>>re);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?t.texImage3D(Y,re,K,de,ue,g.depth,0,ae,X,null):t.texImage2D(Y,re,K,de,ue,0,ae,X,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),je(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,G,Y,Te.__webglTexture,0,Ge(g)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,G,Y,Te.__webglTexture,re),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ut(E,g,F){if(i.bindRenderbuffer(i.RENDERBUFFER,E),g.depthBuffer){const G=g.depthTexture,Y=G&&G.isDepthTexture?G.type:null,re=T(g.stencilBuffer,Y),ae=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;je(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ge(g),re,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ge(g),re,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,re,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ae,i.RENDERBUFFER,E)}else{const G=g.textures;for(let Y=0;Y<G.length;Y++){const re=G[Y],ae=s.convert(re.format,re.colorSpace),X=s.convert(re.type),K=S(re.internalFormat,ae,X,re.normalized,re.colorSpace);je(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ge(g),K,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ge(g),K,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,K,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function He(E,g,F){const G=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const Y=n.get(g.depthTexture);if(Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),G){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,g.depthTexture.addEventListener("dispose",R)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),qe(i.TEXTURE_CUBE_MAP,g.depthTexture);const oe=s.convert(g.depthTexture.format),Te=s.convert(g.depthTexture.type);let de;g.depthTexture.format===gn?de=i.DEPTH_COMPONENT24:g.depthTexture.format===Vn&&(de=i.DEPTH24_STENCIL8);for(let ue=0;ue<6;ue++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,de,g.width,g.height,0,oe,Te,null)}}else W(g.depthTexture,0);const re=Y.__webglTexture,ae=Ge(g),X=G?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,K=g.depthTexture.format===Vn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===gn)je(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,X,re,0,ae):i.framebufferTexture2D(i.FRAMEBUFFER,K,X,re,0);else if(g.depthTexture.format===Vn)je(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,X,re,0,ae):i.framebufferTexture2D(i.FRAMEBUFFER,K,X,re,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function tt(E){const g=n.get(E),F=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const G=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),G){const Y=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,G.removeEventListener("dispose",Y)};G.addEventListener("dispose",Y),g.__depthDisposeCallback=Y}g.__boundDepthTexture=G}if(E.depthTexture&&!g.__autoAllocateDepthBuffer)if(F)for(let G=0;G<6;G++)He(g.__webglFramebuffer[G],E,G);else{const G=E.texture.mipmaps;G&&G.length>0?He(g.__webglFramebuffer[0],E,0):He(g.__webglFramebuffer,E,0)}else if(F){g.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[G]),g.__webglDepthbuffer[G]===void 0)g.__webglDepthbuffer[G]=i.createRenderbuffer(),ut(g.__webglDepthbuffer[G],E,!1);else{const Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=g.__webglDepthbuffer[G];i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,re)}}else{const G=E.texture.mipmaps;if(G&&G.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),ut(g.__webglDepthbuffer,E,!1);else{const Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,re)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Je(E,g,F){const G=n.get(E);g!==void 0&&Me(G.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&tt(E)}function Ue(E){const g=E.texture,F=n.get(E),G=n.get(g);E.addEventListener("dispose",x);const Y=E.textures,re=E.isWebGLCubeRenderTarget===!0,ae=Y.length>1;if(ae||(G.__webglTexture===void 0&&(G.__webglTexture=i.createTexture()),G.__version=g.version,a.memory.textures++),re){F.__webglFramebuffer=[];for(let X=0;X<6;X++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[X]=[];for(let K=0;K<g.mipmaps.length;K++)F.__webglFramebuffer[X][K]=i.createFramebuffer()}else F.__webglFramebuffer[X]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let X=0;X<g.mipmaps.length;X++)F.__webglFramebuffer[X]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(ae)for(let X=0,K=Y.length;X<K;X++){const oe=n.get(Y[X]);oe.__webglTexture===void 0&&(oe.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&je(E)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let X=0;X<Y.length;X++){const K=Y[X];F.__webglColorRenderbuffer[X]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[X]);const oe=s.convert(K.format,K.colorSpace),Te=s.convert(K.type),de=S(K.internalFormat,oe,Te,K.normalized,K.colorSpace,E.isXRRenderTarget===!0),ue=Ge(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,ue,de,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+X,i.RENDERBUFFER,F.__webglColorRenderbuffer[X])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),ut(F.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(re){t.bindTexture(i.TEXTURE_CUBE_MAP,G.__webglTexture),qe(i.TEXTURE_CUBE_MAP,g);for(let X=0;X<6;X++)if(g.mipmaps&&g.mipmaps.length>0)for(let K=0;K<g.mipmaps.length;K++)Me(F.__webglFramebuffer[X][K],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,K);else Me(F.__webglFramebuffer[X],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);f(g)&&A(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ae){for(let X=0,K=Y.length;X<K;X++){const oe=Y[X],Te=n.get(oe);let de=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(de=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,Te.__webglTexture),qe(de,oe),Me(F.__webglFramebuffer,E,oe,i.COLOR_ATTACHMENT0+X,de,0),f(oe)&&A(de)}t.unbindTexture()}else{let X=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(X=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(X,G.__webglTexture),qe(X,g),g.mipmaps&&g.mipmaps.length>0)for(let K=0;K<g.mipmaps.length;K++)Me(F.__webglFramebuffer[K],E,g,i.COLOR_ATTACHMENT0,X,K);else Me(F.__webglFramebuffer,E,g,i.COLOR_ATTACHMENT0,X,0);f(g)&&A(X),t.unbindTexture()}E.depthBuffer&&tt(E)}function dt(E){const g=E.textures;for(let F=0,G=g.length;F<G;F++){const Y=g[F];if(f(Y)){const re=w(E),ae=n.get(Y).__webglTexture;t.bindTexture(re,ae),A(re),t.unbindTexture()}}}const le=[],we=[];function ke(E){if(E.samples>0){if(je(E)===!1){const g=E.textures,F=E.width,G=E.height;let Y=i.COLOR_BUFFER_BIT;const re=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=n.get(E),X=g.length>1;if(X)for(let oe=0;oe<g.length;oe++)t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer);const K=E.texture.mipmaps;K&&K.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let oe=0;oe<g.length;oe++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),X){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ae.__webglColorRenderbuffer[oe]);const Te=n.get(g[oe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Te,0)}i.blitFramebuffer(0,0,F,G,0,0,F,G,Y,i.NEAREST),c===!0&&(le.length=0,we.length=0,le.push(i.COLOR_ATTACHMENT0+oe),E.depthBuffer&&E.resolveDepthBuffer===!1&&(le.push(re),we.push(re),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,we)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,le))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),X)for(let oe=0;oe<g.length;oe++){t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,ae.__webglColorRenderbuffer[oe]);const Te=n.get(g[oe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,Te,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const g=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Ge(E){return Math.min(r.maxSamples,E.samples)}function je(E){const g=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function P(E){const g=a.render.frame;h.get(E)!==g&&(h.set(E,g),E.update())}function We(E,g){const F=E.colorSpace,G=E.format,Y=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||F!==Qi&&F!==yn&&(Ze.getTransfer(F)===it?(G!==kt||Y!==It)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",F)),g}function Ke(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=q,this.resetTextureUnits=H,this.getTextureUnits=$,this.setTextureUnits=O,this.setTexture2D=W,this.setTexture2DArray=J,this.setTexture3D=j,this.setTextureCube=ie,this.rebindTextures=Je,this.setupRenderTarget=Ue,this.updateRenderTargetMipmap=dt,this.updateMultisampleRenderTarget=ke,this.setupDepthRenderbuffer=tt,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=je,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Jp(i,e){function t(n,r=yn){let s;const a=Ze.getTransfer(r);if(n===It)return i.UNSIGNED_BYTE;if(n===ls)return i.UNSIGNED_SHORT_4_4_4_4;if(n===cs)return i.UNSIGNED_SHORT_5_5_5_1;if(n===co)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===uo)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===oo)return i.BYTE;if(n===lo)return i.SHORT;if(n===bi)return i.UNSIGNED_SHORT;if(n===os)return i.INT;if(n===nn)return i.UNSIGNED_INT;if(n===rn)return i.FLOAT;if(n===mn)return i.HALF_FLOAT;if(n===ho)return i.ALPHA;if(n===fo)return i.RGB;if(n===kt)return i.RGBA;if(n===gn)return i.DEPTH_COMPONENT;if(n===Vn)return i.DEPTH_STENCIL;if(n===us)return i.RED;if(n===hs)return i.RED_INTEGER;if(n===Hn)return i.RG;if(n===fs)return i.RG_INTEGER;if(n===ds)return i.RGBA_INTEGER;if(n===qi||n===Yi||n===$i||n===Ki)if(a===it)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===qi)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Yi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===$i)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ki)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===qi)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Yi)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===$i)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ki)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ps||n===ms||n===gs||n===_s)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ps)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ms)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===gs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===_s)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===xs||n===vs||n===Ms||n===Ss||n===Es||n===Zi||n===ys)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===xs||n===vs)return a===it?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ms)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ss)return s.COMPRESSED_R11_EAC;if(n===Es)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Zi)return s.COMPRESSED_RG11_EAC;if(n===ys)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===bs||n===Ts||n===As||n===ws||n===Rs||n===Cs||n===Ps||n===Ds||n===Ls||n===Is||n===Us||n===Ns||n===Fs||n===Os)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===bs)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ts)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===As)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ws)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Rs)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Cs)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ps)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ds)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ls)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Is)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Us)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ns)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Fs)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Os)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Bs||n===zs||n===Gs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Bs)return a===it?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===zs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Gs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Vs||n===Hs||n===Ji||n===ks)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Vs)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Hs)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ji)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ks)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ti?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Qp=`
void main() {
...
}`;class em{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Yo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new on({vertexShader:Qp,fragmentShader:jp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new qt(new Oi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class tm extends bn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,h=null,p=null,u=null,d=null,_=null;const M=typeof XRWebGLBinding<"u",m=new em,f={},A=t.getContextAttributes();let w=null,S=null;const T=[],b=[],R=new Ne;let x=null;const y=new Yt;y.viewport=new ft;const D=new Yt;D.viewport=new ft;const C=[y,D],L=new Vu;let H=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let se=T[Z];return se===void 0&&(se=new na,T[Z]=se),se.getTargetRaySpace()},this.getControllerGrip=function(Z){let se=T[Z];return se===void 0&&(se=new na,T[Z]=se),se.getGripSpace()},this.getHand=function(Z){let se=T[Z];return se===void 0&&(se=new na,T[Z]=se),se.getHandSpace()};function O(Z){const se=b.indexOf(Z.inputSource);if(se===-1)return;const ne=T[se];ne!==void 0&&(ne.update(Z.inputSource,Z.frame,l||a),ne.dispatchEvent({type:Z.type,data:Z.inputSource}))}function q(){r.removeEventListener("select",O),r.removeEventListener("selectstart",O),r.removeEventListener("selectend",O),r.removeEventListener("squeeze",O),r.removeEventListener("squeezestart",O),r.removeEventListener("squeezeend",O),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",V);for(let Z=0;Z<T.length;Z++){const se=b[Z];se!==null&&(b[Z]=null,T[Z].disconnect(se))}H=null,$=null,m.reset();for(const Z in f)delete f[Z];e.setRenderTarget(w),d=null,u=null,p=null,r=null,S=null,qe.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&De("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&De("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Z){l=Z},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return p===null&&M&&(p=new XRWebGLBinding(r,t)),p},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(Z){if(r=Z,r!==null){if(w=e.getRenderTarget(),r.addEventListener("select",O),r.addEventListener("selectstart",O),r.addEventListener("selectend",O),r.addEventListener("squeeze",O),r.addEventListener("squeezestart",O),r.addEventListener("squeezeend",O),r.addEventListener("end",q),r.addEventListener("inputsourceschange",V),A.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(R),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let ne=null,be=null,Ie=null;A.depth&&(Ie=A.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ne=A.stencil?Vn:gn,be=A.stencil?Ti:nn);const Me={colorFormat:t.RGBA8,depthFormat:Ie,scaleFactor:s};p=this.getBinding(),u=p.createProjectionLayer(Me),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),S=new an(u.textureWidth,u.textureHeight,{format:kt,type:It,depthTexture:new pi(u.textureWidth,u.textureHeight,be,void 0,void 0,void 0,void 0,void 0,void 0,ne),stencilBuffer:A.stencil,colorSpace:e.outputColorSpace,samples:A.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const ne={antialias:A.antialias,alpha:!0,depth:A.depth,stencil:A.stencil,framebufferScaleFactor:s};d=new XRWebGLLayer(r,t,ne),r.updateRenderState({baseLayer:d}),e.setPixelRatio(1),e.setSize(d.framebufferWidth,d.framebufferHeight,!1),S=new an(d.framebufferWidth,d.framebufferHeight,{format:kt,type:It,colorSpace:e.outputColorSpace,stencilBuffer:A.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),qe.setContext(r),qe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function V(Z){for(let se=0;se<Z.removed.length;se++){const ne=Z.removed[se],be=b.indexOf(ne);be>=0&&(b[be]=null,T[be].disconnect(ne))}for(let se=0;se<Z.added.length;se++){const ne=Z.added[se];let be=b.indexOf(ne);if(be===-1){for(let Me=0;Me<T.length;Me++)if(Me>=b.length){b.push(ne),be=Me;break}else if(b[Me]===null){b[Me]=ne,be=Me;break}if(be===-1)break}const Ie=T[be];Ie&&Ie.connect(ne)}}const W=new U,J=new U;function j(Z,se,ne){W.setFromMatrixPosition(se.matrixWorld),J.setFromMatrixPosition(ne.matrixWorld);const be=W.distanceTo(J),Ie=se.projectionMatrix.elements,Me=ne.projectionMatrix.elements,ut=Ie[14]/(Ie[10]-1),He=Ie[14]/(Ie[10]+1),tt=(Ie[9]+1)/Ie[5],Je=(Ie[9]-1)/Ie[5],Ue=(Ie[8]-1)/Ie[0],dt=(Me[8]+1)/Me[0],le=ut*Ue,we=ut*dt,ke=be/(-Ue+dt),Ge=ke*-Ue;if(se.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Ge),Z.translateZ(ke),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Ie[10]===-1)Z.projectionMatrix.copy(se.projectionMatrix),Z.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{const je=ut+ke,P=He+ke,We=le-Ge,Ke=we+(be-Ge),E=tt*He/P*je,g=Je*He/P*je;Z.projectionMatrix.makePerspective(We,Ke,E,g,je,P),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function ie(Z,se){se===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(se.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(r===null)return;let se=Z.near,ne=Z.far;m.texture!==null&&(m.depthNear>0&&(se=m.depthNear),m.depthFar>0&&(ne=m.depthFar)),L.near=D.near=y.near=se,L.far=D.far=y.far=ne,(H!==L.near||$!==L.far)&&(r.updateRenderState({depthNear:L.near,depthFar:L.far}),H=L.near,$=L.far),L.layers.mask=Z.layers.mask|6,y.layers.mask=L.layers.mask&-5,D.layers.mask=L.layers.mask&-3;const be=Z.parent,Ie=L.cameras;ie(L,be);for(let Me=0;Me<Ie.length;Me++)ie(Ie[Me],be);Ie.length===2?j(L,y,D):L.projectionMatrix.copy(y.projectionMatrix),_e(Z,L,be)};function _e(Z,se,ne){ne===null?Z.matrix.copy(se.matrixWorld):(Z.matrix.copy(ne.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(se.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(se.projectionMatrix),Z.projectionMatrixInverse.copy(se.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=$s*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(u===null&&d===null))return c},this.setFoveation=function(Z){c=Z,u!==null&&(u.fixedFoveation=Z),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=Z)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(L)},this.getCameraTexture=function(Z){return f[Z]};let ze=null;function nt(Z,se){if(h=se.getViewerPose(l||a),_=se,h!==null){const ne=h.views;d!==null&&(e.setRenderTargetFramebuffer(S,d.framebuffer),e.setRenderTarget(S));let be=!1;ne.length!==L.cameras.length&&(L.cameras.length=0,be=!0);for(let He=0;He<ne.length;He++){const tt=ne[He];let Je=null;if(d!==null)Je=d.getViewport(tt);else{const dt=p.getViewSubImage(u,tt);Je=dt.viewport,He===0&&(e.setRenderTargetTextures(S,dt.colorTexture,dt.depthStencilTexture),e.setRenderTarget(S))}let Ue=C[He];Ue===void 0&&(Ue=new Yt,Ue.layers.enable(He),Ue.viewport=new ft,C[He]=Ue),Ue.matrix.fromArray(tt.transform.matrix),Ue.matrix.decompose(Ue.position,Ue.quaternion,Ue.scale),Ue.projectionMatrix.fromArray(tt.projectionMatrix),Ue.projectionMatrixInverse.copy(Ue.projectionMatrix).invert(),Ue.viewport.set(Je.x,Je.y,Je.width,Je.height),He===0&&(L.matrix.copy(Ue.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),be===!0&&L.cameras.push(Ue)}const Ie=r.enabledFeatures;if(Ie&&Ie.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){p=n.getBinding();const He=p.getDepthInformation(ne[0]);He&&He.isValid&&He.texture&&m.init(He,r.renderState)}if(Ie&&Ie.includes("camera-access")&&M){e.state.unbindTexture(),p=n.getBinding();for(let He=0;He<ne.length;He++){const tt=ne[He].camera;if(tt){let Je=f[tt];Je||(Je=new Yo,f[tt]=Je);const Ue=p.getCameraImage(tt);Je.sourceTexture=Ue}}}}for(let ne=0;ne<T.length;ne++){const be=b[ne],Ie=T[ne];be!==null&&Ie!==void 0&&Ie.update(be,se,l||a)}ze&&ze(Z,se),se.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:se}),_=null}const qe=new ol;qe.setAnimationLoop(nt),this.setAnimationLoop=function(Z){ze=Z},this.dispose=function(){}}}const nm=new ht,Ol=new Fe;Ol.set(-1,0,0,0,1,0,0,0,1);function im(i,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,Zo(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,A,w,S){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?s(m,f):f.isMeshLambertMaterial?(s(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(s(m,f),p(m,f)):f.isMeshPhongMaterial?(s(m,f),h(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(s(m,f),u(m,f),f.isMeshPhysicalMaterial&&d(m,f,S)):f.isMeshMatcapMaterial?(s(m,f),_(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),M(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?c(m,f,A,w):f.isSpriteMaterial?l(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Lt&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Lt&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const A=e.get(f),w=A.envMap,S=A.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(nm.makeRotationFromEuler(S)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Ol),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function c(m,f,A,w){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*A,m.scale.value=w*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function l(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function p(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function u(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function d(m,f,A){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Lt&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=A.texture,m.transmissionSamplerSize.value.set(A.width,A.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,f){f.matcap&&(m.matcap.value=f.matcap)}function M(m,f){const A=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(A.matrixWorld),m.nearDistance.value=A.shadow.camera.near,m.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function rm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(S,T){const b=T.program;n.uniformBlockBinding(S,b)}function l(S,T){let b=r[S.id];b===void 0&&(m(S),b=h(S),r[S.id]=b,S.addEventListener("dispose",A));const R=T.program;n.updateUBOMapping(S,R);const x=e.render.frame;s[S.id]!==x&&(u(S),s[S.id]=x)}function h(S){const T=p();S.__bindingPointIndex=T;const b=i.createBuffer(),R=S.__size,x=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,R,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,b),b}function p(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Qe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(S){const T=r[S.id],b=S.uniforms,R=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let x=0,y=b.length;x<y;x++){const D=b[x];if(Array.isArray(D))for(let C=0,L=D.length;C<L;C++)d(D[C],x,C,R);else d(D,x,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function d(S,T,b,R){if(M(S,T,b,R)===!0){const x=S.__offset,y=S.value;if(Array.isArray(y)){let D=0;for(let C=0;C<y.length;C++){const L=y[C],H=f(L);_(L,S.__data,D),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(D+=H.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(y,S.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,S.__data)}}function _(S,T,b){typeof S=="number"||typeof S=="boolean"?T[0]=S:S.isMatrix3?(T[0]=S.elements[0],T[1]=S.elements[1],T[2]=S.elements[2],T[3]=0,T[4]=S.elements[3],T[5]=S.elements[4],T[6]=S.elements[5],T[7]=0,T[8]=S.elements[6],T[9]=S.elements[7],T[10]=S.elements[8],T[11]=0):ArrayBuffer.isView(S)?T.set(new S.constructor(S.buffer,S.byteOffset,T.length)):S.toArray(T,b)}function M(S,T,b,R){const x=S.value,y=T+"_"+b;if(R[y]===void 0)return typeof x=="number"||typeof x=="boolean"?R[y]=x:ArrayBuffer.isView(x)?R[y]=x.slice():R[y]=x.clone(),!0;{const D=R[y];if(typeof x=="number"||typeof x=="boolean"){if(D!==x)return R[y]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(D.equals(x)===!1)return D.copy(x),!0}}return!1}function m(S){const T=S.uniforms;let b=0;const R=16;for(let y=0,D=T.length;y<D;y++){const C=Array.isArray(T[y])?T[y]:[T[y]];for(let L=0,H=C.length;L<H;L++){const $=C[L],O=Array.isArray($.value)?$.value:[$.value];for(let q=0,V=O.length;q<V;q++){const W=O[q],J=f(W),j=b%R,ie=j%J.boundary,_e=j+ie;b+=ie,_e!==0&&R-_e<J.storage&&(b+=R-_e),$.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=b,b+=J.storage}}}const x=b%R;return x>0&&(b+=R-x),S.__size=b,S.__cache={},this}function f(S){const T={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(T.boundary=4,T.storage=4):S.isVector2?(T.boundary=8,T.storage=8):S.isVector3||S.isColor?(T.boundary=16,T.storage=12):S.isVector4?(T.boundary=16,T.storage=16):S.isMatrix3?(T.boundary=48,T.storage=48):S.isMatrix4?(T.boundary=64,T.storage=64):S.isTexture?De("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(T.boundary=16,T.storage=S.byteLength):De("WebGLRenderer: Unsupported uniform value type.",S),T}function A(S){const T=S.target;T.removeEventListener("dispose",A);const b=a.indexOf(T.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function w(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:c,update:l,dispose:w}}const sm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let un=null;function am(){return un===null&&(un=new zo(sm,16,16,Hn,mn),un.name="DFG_LUT",un.minFilter=vt,un.magFilter=vt,un.wrapS=Ft,un.wrapT=Ft,un.generateMipmaps=!1,un.needsUpdate=!0),un}class om{constructor(e={}){const{canvas:t=jc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:d=It}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const M=d,m=new Set([ds,fs,hs]),f=new Set([It,nn,bi,Ti,ls,cs]),A=new Uint32Array(4),w=new Int32Array(4),S=new U;let T=null,b=null;const R=[],x=[];let y=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const D=this;let C=!1,L=null,H=null,$=null,O=null;this._outputColorSpace=Wt;let q=0,V=0,W=null,J=-1,j=null;const ie=new ft,_e=new ft;let ze=null;const nt=new Xe(0);let qe=0,Z=t.width,se=t.height,ne=1,be=null,Ie=null;const Me=new ft(0,0,Z,se),ut=new ft(0,0,Z,se);let He=!1;const tt=new Ma;let Je=!1,Ue=!1;const dt=new ht,le=new U,we=new ft,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ge=!1;function je(){return W===null?ne:1}let P=n;function We(v,N){return t.getContext(v,N)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${qr}`),t.addEventListener("webglcontextlost",pt,!1),t.addEventListener("webglcontextrestored",lt,!1),t.addEventListener("webglcontextcreationerror",hn,!1),P===null){const N="webgl2";if(P=We(N,v),P===null)throw We(N)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(v){throw Qe("WebGLRenderer: "+v.message),v}let Ke,E,g,F,G,Y,re,ae,X,K,oe,Te,de,ue,Ce,Le,Oe,I,ce,Q,he,ge,ee;function ye(){Ke=new ad(P),Ke.init(),he=new Jp(P,Ke),E=new Qf(P,Ke,e,he),g=new Kp(P,Ke),E.reversedDepthBuffer&&u&&g.buffers.depth.setReversed(!0),H=P.createFramebuffer(),$=P.createFramebuffer(),O=P.createFramebuffer(),F=new cd(P),G=new Np,Y=new Zp(P,Ke,g,G,E,he,F),re=new sd(D),ae=new qu(P),ge=new Zf(P,ae),X=new od(P,ae,F,ge),K=new hd(P,X,ae,ge,F),I=new ud(P,E,Y),Ce=new jf(G),oe=new Up(D,re,Ke,E,ge,Ce),Te=new im(D,G),de=new Op,ue=new kp(Ke),Oe=new Kf(D,re,g,K,_,c),Le=new $p(D,K,E),ee=new rm(P,F,E,g),ce=new Jf(P,Ke,F),Q=new ld(P,Ke,F),F.programs=oe.programs,D.capabilities=E,D.extensions=Ke,D.properties=G,D.renderLists=de,D.shadowMap=Le,D.state=g,D.info=F}ye(),M!==It&&(y=new dd(M,t.width,t.height,o,r,s));const Se=new tm(D,P);this.xr=Se,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const v=Ke.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Ke.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return ne},this.setPixelRatio=function(v){v!==void 0&&(ne=v,this.setSize(Z,se,!1))},this.getSize=function(v){return v.set(Z,se)},this.setSize=function(v,N,k=!0){if(Se.isPresenting){De("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=v,se=N,t.width=Math.floor(v*ne),t.height=Math.floor(N*ne),k===!0&&(t.style.width=v+"px",t.style.height=N+"px"),y!==null&&y.setSize(t.width,t.height),this.setViewport(0,0,v,N)},this.getDrawingBufferSize=function(v){return v.set(Z*ne,se*ne).floor()},this.setDrawingBufferSize=function(v,N,k){Z=v,se=N,ne=k,t.width=Math.floor(v*k),t.height=Math.floor(N*k),this.setViewport(0,0,v,N)},this.setEffects=function(v){if(M===It){Qe("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let N=0;N<v.length;N++)if(v[N].isOutputPass===!0){De("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}y.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(ie)},this.getViewport=function(v){return v.copy(Me)},this.setViewport=function(v,N,k,B){v.isVector4?Me.set(v.x,v.y,v.z,v.w):Me.set(v,N,k,B),g.viewport(ie.copy(Me).multiplyScalar(ne).round())},this.getScissor=function(v){return v.copy(ut)},this.setScissor=function(v,N,k,B){v.isVector4?ut.set(v.x,v.y,v.z,v.w):ut.set(v,N,k,B),g.scissor(_e.copy(ut).multiplyScalar(ne).round())},this.getScissorTest=function(){return He},this.setScissorTest=function(v){g.setScissorTest(He=v)},this.setOpaqueSort=function(v){be=v},this.setTransparentSort=function(v){Ie=v},this.getClearColor=function(v){return v.copy(Oe.getClearColor())},this.setClearColor=function(){Oe.setClearColor(...arguments)},this.getClearAlpha=function(){return Oe.getClearAlpha()},this.setClearAlpha=function(){Oe.setClearAlpha(...arguments)},this.clear=function(v=!0,N=!0,k=!0){let B=0;if(v){let z=!1;if(W!==null){const me=W.texture.format;z=m.has(me)}if(z){const me=W.texture.type,ve=f.has(me),pe=Oe.getClearColor(),Ee=Oe.getClearAlpha(),Ae=pe.r,Be=pe.g,Ye=pe.b;ve?(A[0]=Ae,A[1]=Be,A[2]=Ye,A[3]=Ee,P.clearBufferuiv(P.COLOR,0,A)):(w[0]=Ae,w[1]=Be,w[2]=Ye,w[3]=Ee,P.clearBufferiv(P.COLOR,0,w))}else B|=P.COLOR_BUFFER_BIT}N&&(B|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),k&&(B|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&P.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),L=v},this.dispose=function(){t.removeEventListener("webglcontextlost",pt,!1),t.removeEventListener("webglcontextrestored",lt,!1),t.removeEventListener("webglcontextcreationerror",hn,!1),Oe.dispose(),de.dispose(),ue.dispose(),G.dispose(),re.dispose(),K.dispose(),ge.dispose(),ee.dispose(),oe.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",fc),Se.removeEventListener("sessionend",dc),Kn.stop()};function pt(v){v.preventDefault(),_o("WebGLRenderer: Context Lost."),C=!0}function lt(){_o("WebGLRenderer: Context Restored."),C=!1;const v=F.autoReset,N=Le.enabled,k=Le.autoUpdate,B=Le.needsUpdate,z=Le.type;ye(),F.autoReset=v,Le.enabled=N,Le.autoUpdate=k,Le.needsUpdate=B,Le.type=z}function hn(v){Qe("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function fn(v){const N=v.target;N.removeEventListener("dispose",fn),Ag(N)}function Ag(v){wg(v),G.remove(v)}function wg(v){const N=G.get(v).programs;N!==void 0&&(N.forEach(function(k){oe.releaseProgram(k)}),v.isShaderMaterial&&oe.releaseShaderCache(v))}this.renderBufferDirect=function(v,N,k,B,z,me){N===null&&(N=ke);const ve=z.isMesh&&z.matrixWorld.determinantAffine()<0,pe=Pg(v,N,k,B,z);g.setMaterial(B,ve);let Ee=k.index,Ae=1;if(B.wireframe===!0){if(Ee=X.getWireframeAttribute(k),Ee===void 0)return;Ae=2}const Be=k.drawRange,Ye=k.attributes.position;let Re=Be.start*Ae,st=(Be.start+Be.count)*Ae;me!==null&&(Re=Math.max(Re,me.start*Ae),st=Math.min(st,(me.start+me.count)*Ae)),Ee!==null?(Re=Math.max(Re,0),st=Math.min(st,Ee.count)):Ye!=null&&(Re=Math.max(Re,0),st=Math.min(st,Ye.count));const _t=st-Re;if(_t<0||_t===1/0)return;ge.setup(z,B,pe,k,Ee);let mt,at=ce;if(Ee!==null&&(mt=ae.get(Ee),at=Q,at.setIndex(mt)),z.isMesh)B.wireframe===!0?(g.setLineWidth(B.wireframeLinewidth*je()),at.setMode(P.LINES)):at.setMode(P.TRIANGLES);else if(z.isLine){let Dt=B.linewidth;Dt===void 0&&(Dt=1),g.setLineWidth(Dt*je()),z.isLineSegments?at.setMode(P.LINES):z.isLineLoop?at.setMode(P.LINE_LOOP):at.setMode(P.LINE_STRIP)}else z.isPoints?at.setMode(P.POINTS):z.isSprite&&at.setMode(P.TRIANGLES);if(z.isBatchedMesh)if(Ke.get("WEBGL_multi_draw"))at.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Dt=z._multiDrawStarts,xe=z._multiDrawCounts,Vt=z._multiDrawCount,et=Ee?ae.get(Ee).bytesPerElement:1,$t=G.get(B).currentProgram.getUniforms();for(let dn=0;dn<Vt;dn++)$t.setValue(P,"_gl_DrawID",dn),at.render(Dt[dn]/et,xe[dn])}else if(z.isInstancedMesh)at.renderInstances(Re,_t,z.count);else if(k.isInstancedBufferGeometry){const Dt=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,xe=Math.min(k.instanceCount,Dt);at.renderInstances(Re,_t,xe)}else at.render(Re,_t)};function hc(v,N,k){v.transparent===!0&&v.side===Ht&&v.forceSinglePass===!1?(v.side=Lt,v.needsUpdate=!0,Xr(v,N,k),v.side=en,v.needsUpdate=!0,Xr(v,N,k),v.side=Ht):Xr(v,N,k)}this.compile=function(v,N,k=null){k===null&&(k=v),b=ue.get(k),b.init(N),x.push(b),k.traverseVisible(function(z){z.isLight&&z.layers.test(N.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),v!==k&&v.traverseVisible(function(z){z.isLight&&z.layers.test(N.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),b.setupLights();const B=new Set;return v.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const me=z.material;if(me)if(Array.isArray(me))for(let ve=0;ve<me.length;ve++){const pe=me[ve];hc(pe,k,z),B.add(pe)}else hc(me,k,z),B.add(me)}),b=x.pop(),B},this.compileAsync=function(v,N,k=null){const B=this.compile(v,N,k);return new Promise(z=>{function me(){if(B.forEach(function(ve){G.get(ve).currentProgram.isReady()&&B.delete(ve)}),B.size===0){z(v);return}setTimeout(me,10)}Ke.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let qa=null;function Rg(v){qa&&qa(v)}function fc(){Kn.stop()}function dc(){Kn.start()}const Kn=new ol;Kn.setAnimationLoop(Rg),typeof self<"u"&&Kn.setContext(self),this.setAnimationLoop=function(v){qa=v,Se.setAnimationLoop(v),v===null?Kn.stop():Kn.start()},Se.addEventListener("sessionstart",fc),Se.addEventListener("sessionend",dc),this.render=function(v,N){if(N!==void 0&&N.isCamera!==!0){Qe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;L!==null&&L.renderStart(v,N);const k=Se.enabled===!0&&Se.isPresenting===!0,B=y!==null&&(W===null||k)&&y.begin(D,W);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(y===null||y.isCompositing()===!1)&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(N),N=Se.getCamera()),v.isScene===!0&&v.onBeforeRender(D,v,N,W),b=ue.get(v,x.length),b.init(N),b.state.textureUnits=Y.getTextureUnits(),x.push(b),dt.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),tt.setFromProjectionMatrix(dt,sn,N.reversedDepth),Ue=this.localClippingEnabled,Je=Ce.init(this.clippingPlanes,Ue),T=de.get(v,R.length),T.init(),R.push(T),Se.enabled===!0&&Se.isPresenting===!0){const ve=D.xr.getDepthSensingMesh();ve!==null&&Ya(ve,N,-1/0,D.sortObjects)}Ya(v,N,0,D.sortObjects),T.finish(),D.sortObjects===!0&&T.sort(be,Ie,N.reversedDepth),Ge=Se.enabled===!1||Se.isPresenting===!1||Se.hasDepthSensing()===!1,Ge&&Oe.addToRenderList(T,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Je===!0&&Ce.beginShadows();const z=b.state.shadowsArray;if(Le.render(z,v,N),Je===!0&&Ce.endShadows(),(B&&y.hasRenderPass())===!1){const ve=T.opaque,pe=T.transmissive;if(b.setupLights(),N.isArrayCamera){const Ee=N.cameras;if(pe.length>0)for(let Ae=0,Be=Ee.length;Ae<Be;Ae++){const Ye=Ee[Ae];mc(ve,pe,v,Ye)}Ge&&Oe.render(v);for(let Ae=0,Be=Ee.length;Ae<Be;Ae++){const Ye=Ee[Ae];pc(T,v,Ye,Ye.viewport)}}else pe.length>0&&mc(ve,pe,v,N),Ge&&Oe.render(v),pc(T,v,N)}W!==null&&V===0&&(Y.updateMultisampleRenderTarget(W),Y.updateRenderTargetMipmap(W)),B&&y.end(D),v.isScene===!0&&v.onAfterRender(D,v,N),ge.resetDefaultState(),J=-1,j=null,x.pop(),x.length>0?(b=x[x.length-1],Y.setTextureUnits(b.state.textureUnits),Je===!0&&Ce.setGlobalState(D.clippingPlanes,b.state.camera)):b=null,R.pop(),R.length>0?T=R[R.length-1]:T=null,L!==null&&L.renderEnd()};function Ya(v,N,k,B){if(v.visible===!1)return;if(v.layers.test(N.layers)){if(v.isGroup)k=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(N);else if(v.isLightProbeGrid)b.pushLightProbeGrid(v);else if(v.isLight)b.pushLight(v),v.castShadow&&b.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||tt.intersectsSprite(v)){B&&we.setFromMatrixPosition(v.matrixWorld).applyMatrix4(dt);const ve=K.update(v),pe=v.material;pe.visible&&T.push(v,ve,pe,k,we.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||tt.intersectsObject(v))){const ve=K.update(v),pe=v.material;if(B&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),we.copy(v.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),we.copy(ve.boundingSphere.center)),we.applyMatrix4(v.matrixWorld).applyMatrix4(dt)),Array.isArray(pe)){const Ee=ve.groups;for(let Ae=0,Be=Ee.length;Ae<Be;Ae++){const Ye=Ee[Ae],Re=pe[Ye.materialIndex];Re&&Re.visible&&T.push(v,ve,Re,k,we.z,Ye)}}else pe.visible&&T.push(v,ve,pe,k,we.z,null)}}const me=v.children;for(let ve=0,pe=me.length;ve<pe;ve++)Ya(me[ve],N,k,B)}function pc(v,N,k,B){const{opaque:z,transmissive:me,transparent:ve}=v;b.setupLightsView(k),Je===!0&&Ce.setGlobalState(D.clippingPlanes,k),B&&g.viewport(ie.copy(B)),z.length>0&&Wr(z,N,k),me.length>0&&Wr(me,N,k),ve.length>0&&Wr(ve,N,k),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function mc(v,N,k,B){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[B.id]===void 0){const Re=Ke.has("EXT_color_buffer_half_float")||Ke.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[B.id]=new an(1,1,{generateMipmaps:!0,type:Re?mn:It,minFilter:Gn,samples:Math.max(4,E.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ze.workingColorSpace})}const me=b.state.transmissionRenderTarget[B.id],ve=B.viewport||ie;me.setSize(ve.z*D.transmissionResolutionScale,ve.w*D.transmissionResolutionScale);const pe=D.getRenderTarget(),Ee=D.getActiveCubeFace(),Ae=D.getActiveMipmapLevel();D.setRenderTarget(me),D.getClearColor(nt),qe=D.getClearAlpha(),qe<1&&D.setClearColor(16777215,.5),D.clear(),Ge&&Oe.render(k);const Be=D.toneMapping;D.toneMapping=tn;const Ye=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),b.setupLightsView(B),Je===!0&&Ce.setGlobalState(D.clippingPlanes,B),Wr(v,k,B),Y.updateMultisampleRenderTarget(me),Y.updateRenderTargetMipmap(me),Ke.has("WEBGL_multisampled_render_to_texture")===!1){let Re=!1;for(let st=0,_t=N.length;st<_t;st++){const mt=N[st],{object:at,geometry:Dt,material:xe,group:Vt}=mt;if(xe.side===Ht&&at.layers.test(B.layers)){const et=xe.side;xe.side=Lt,xe.needsUpdate=!0,gc(at,k,B,Dt,xe,Vt),xe.side=et,xe.needsUpdate=!0,Re=!0}}Re===!0&&(Y.updateMultisampleRenderTarget(me),Y.updateRenderTargetMipmap(me))}D.setRenderTarget(pe,Ee,Ae),D.setClearColor(nt,qe),Ye!==void 0&&(B.viewport=Ye),D.toneMapping=Be}function Wr(v,N,k){const B=N.isScene===!0?N.overrideMaterial:null;for(let z=0,me=v.length;z<me;z++){const ve=v[z],{object:pe,geometry:Ee,group:Ae}=ve;let Be=ve.material;Be.allowOverride===!0&&B!==null&&(Be=B),pe.layers.test(k.layers)&&gc(pe,N,k,Ee,Be,Ae)}}function gc(v,N,k,B,z,me){v.onBeforeRender(D,N,k,B,z,me),v.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),z.onBeforeRender(D,N,k,B,v,me),z.transparent===!0&&z.side===Ht&&z.forceSinglePass===!1?(z.side=Lt,z.needsUpdate=!0,D.renderBufferDirect(k,N,B,z,v,me),z.side=en,z.needsUpdate=!0,D.renderBufferDirect(k,N,B,z,v,me),z.side=Ht):D.renderBufferDirect(k,N,B,z,v,me),v.onAfterRender(D,N,k,B,z,me)}function Xr(v,N,k){N.isScene!==!0&&(N=ke);const B=G.get(v),z=b.state.lights,me=b.state.shadowsArray,ve=z.state.version,pe=oe.getParameters(v,z.state,me,N,k,b.state.lightProbeGridArray),Ee=oe.getProgramCacheKey(pe);let Ae=B.programs;B.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?N.environment:null,B.fog=N.fog;const Be=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;B.envMap=re.get(v.envMap||B.environment,Be),B.envMapRotation=B.environment!==null&&v.envMap===null?N.environmentRotation:v.envMapRotation,Ae===void 0&&(v.addEventListener("dispose",fn),Ae=new Map,B.programs=Ae);let Ye=Ae.get(Ee);if(Ye!==void 0){if(B.currentProgram===Ye&&B.lightsStateVersion===ve)return xc(v,pe),Ye}else pe.uniforms=oe.getUniforms(v),L!==null&&v.isNodeMaterial&&L.build(v,k,pe),v.onBeforeCompile(pe,D),Ye=oe.acquireProgram(pe,Ee),Ae.set(Ee,Ye),B.uniforms=pe.uniforms;const Re=B.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Re.clippingPlanes=Ce.uniform),xc(v,pe),B.needsLights=Lg(v),B.lightsStateVersion=ve,B.needsLights&&(Re.ambientLightColor.value=z.state.ambient,Re.lightProbe.value=z.state.probe,Re.directionalLights.value=z.state.directional,Re.directionalLightShadows.value=z.state.directionalShadow,Re.spotLights.value=z.state.spot,Re.spotLightShadows.value=z.state.spotShadow,Re.rectAreaLights.value=z.state.rectArea,Re.ltc_1.value=z.state.rectAreaLTC1,Re.ltc_2.value=z.state.rectAreaLTC2,Re.pointLights.value=z.state.point,Re.pointLightShadows.value=z.state.pointShadow,Re.hemisphereLights.value=z.state.hemi,Re.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Re.spotLightMatrix.value=z.state.spotLightMatrix,Re.spotLightMap.value=z.state.spotLightMap,Re.pointShadowMatrix.value=z.state.pointShadowMatrix),B.lightProbeGrid=b.state.lightProbeGridArray.length>0,B.currentProgram=Ye,B.uniformsList=null,Ye}function _c(v){if(v.uniformsList===null){const N=v.currentProgram.getUniforms();v.uniformsList=Ir.seqWithValue(N.seq,v.uniforms)}return v.uniformsList}function xc(v,N){const k=G.get(v);k.outputColorSpace=N.outputColorSpace,k.batching=N.batching,k.batchingColor=N.batchingColor,k.instancing=N.instancing,k.instancingColor=N.instancingColor,k.instancingMorph=N.instancingMorph,k.skinning=N.skinning,k.morphTargets=N.morphTargets,k.morphNormals=N.morphNormals,k.morphColors=N.morphColors,k.morphTargetsCount=N.morphTargetsCount,k.numClippingPlanes=N.numClippingPlanes,k.numIntersection=N.numClipIntersection,k.vertexAlphas=N.vertexAlphas,k.vertexTangents=N.vertexTangents,k.toneMapping=N.toneMapping}function Cg(v,N){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;S.setFromMatrixPosition(N.matrixWorld);for(let k=0,B=v.length;k<B;k++){const z=v[k];if(z.texture!==null&&z.boundingBox.containsPoint(S))return z}return null}function Pg(v,N,k,B,z){N.isScene!==!0&&(N=ke),Y.resetTextureUnits();const me=N.fog,ve=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?N.environment:null,pe=W===null?D.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:Ze.workingColorSpace,Ee=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Ae=re.get(B.envMap||ve,Ee),Be=B.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Ye=!!k.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Re=!!k.morphAttributes.position,st=!!k.morphAttributes.normal,_t=!!k.morphAttributes.color;let mt=tn;B.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(mt=D.toneMapping);const at=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,Dt=at!==void 0?at.length:0,xe=G.get(B),Vt=b.state.lights;if(Je===!0&&(Ue===!0||v!==j)){const ct=v===j&&B.id===J;Ce.setState(B,v,ct)}let et=!1;B.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==Vt.state.version||xe.outputColorSpace!==pe||z.isBatchedMesh&&xe.batching===!1||!z.isBatchedMesh&&xe.batching===!0||z.isBatchedMesh&&xe.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&xe.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&xe.instancing===!1||!z.isInstancedMesh&&xe.instancing===!0||z.isSkinnedMesh&&xe.skinning===!1||!z.isSkinnedMesh&&xe.skinning===!0||z.isInstancedMesh&&xe.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&xe.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&xe.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&xe.instancingMorph===!1&&z.morphTexture!==null||xe.envMap!==Ae||B.fog===!0&&xe.fog!==me||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Ce.numPlanes||xe.numIntersection!==Ce.numIntersection)||xe.vertexAlphas!==Be||xe.vertexTangents!==Ye||xe.morphTargets!==Re||xe.morphNormals!==st||xe.morphColors!==_t||xe.toneMapping!==mt||xe.morphTargetsCount!==Dt||!!xe.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(et=!0):(et=!0,xe.__version=B.version);let $t=xe.currentProgram;et===!0&&($t=Xr(B,N,z),L&&B.isNodeMaterial&&L.onUpdateProgram(B,$t,xe));let dn=!1,Nn=!1,Si=!1;const ot=$t.getUniforms(),xt=xe.uniforms;if(g.useProgram($t.program)&&(dn=!0,Nn=!0,Si=!0),B.id!==J&&(J=B.id,Nn=!0),xe.needsLights){const ct=Cg(b.state.lightProbeGridArray,z);xe.lightProbeGrid!==ct&&(xe.lightProbeGrid=ct,Nn=!0)}if(dn||j!==v){g.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),ot.setValue(P,"projectionMatrix",v.projectionMatrix),ot.setValue(P,"viewMatrix",v.matrixWorldInverse);const On=ot.map.cameraPosition;On!==void 0&&On.setValue(P,le.setFromMatrixPosition(v.matrixWorld)),E.logarithmicDepthBuffer&&ot.setValue(P,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&ot.setValue(P,"isOrthographic",v.isOrthographicCamera===!0),j!==v&&(j=v,Nn=!0,Si=!0)}if(xe.needsLights&&(Vt.state.directionalShadowMap.length>0&&ot.setValue(P,"directionalShadowMap",Vt.state.directionalShadowMap,Y),Vt.state.spotShadowMap.length>0&&ot.setValue(P,"spotShadowMap",Vt.state.spotShadowMap,Y),Vt.state.pointShadowMap.length>0&&ot.setValue(P,"pointShadowMap",Vt.state.pointShadowMap,Y)),z.isSkinnedMesh){ot.setOptional(P,z,"bindMatrix"),ot.setOptional(P,z,"bindMatrixInverse");const ct=z.skeleton;ct&&(ct.boneTexture===null&&ct.computeBoneTexture(),ot.setValue(P,"boneTexture",ct.boneTexture,Y))}z.isBatchedMesh&&(ot.setOptional(P,z,"batchingTexture"),ot.setValue(P,"batchingTexture",z._matricesTexture,Y),ot.setOptional(P,z,"batchingIdTexture"),ot.setValue(P,"batchingIdTexture",z._indirectTexture,Y),ot.setOptional(P,z,"batchingColorTexture"),z._colorsTexture!==null&&ot.setValue(P,"batchingColorTexture",z._colorsTexture,Y));const Fn=k.morphAttributes;if((Fn.position!==void 0||Fn.normal!==void 0||Fn.color!==void 0)&&I.update(z,k,$t),(Nn||xe.receiveShadow!==z.receiveShadow)&&(xe.receiveShadow=z.receiveShadow,ot.setValue(P,"receiveShadow",z.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&N.environment!==null&&(xt.envMapIntensity.value=N.environmentIntensity),xt.dfgLUT!==void 0&&(xt.dfgLUT.value=am()),Nn){if(ot.setValue(P,"toneMappingExposure",D.toneMappingExposure),xe.needsLights&&Dg(xt,Si),me&&B.fog===!0&&Te.refreshFogUniforms(xt,me),Te.refreshMaterialUniforms(xt,B,ne,se,b.state.transmissionRenderTarget[v.id]),xe.needsLights&&xe.lightProbeGrid){const ct=xe.lightProbeGrid;xt.probesSH.value=ct.texture,xt.probesMin.value.copy(ct.boundingBox.min),xt.probesMax.value.copy(ct.boundingBox.max),xt.probesResolution.value.copy(ct.resolution)}Ir.upload(P,_c(xe),xt,Y)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Ir.upload(P,_c(xe),xt,Y),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&ot.setValue(P,"center",z.center),ot.setValue(P,"modelViewMatrix",z.modelViewMatrix),ot.setValue(P,"normalMatrix",z.normalMatrix),ot.setValue(P,"modelMatrix",z.matrixWorld),B.uniformsGroups!==void 0){const ct=B.uniformsGroups;for(let On=0,Ei=ct.length;On<Ei;On++){const vc=ct[On];ee.update(vc,$t),ee.bind(vc,$t)}}return $t}function Dg(v,N){v.ambientLightColor.needsUpdate=N,v.lightProbe.needsUpdate=N,v.directionalLights.needsUpdate=N,v.directionalLightShadows.needsUpdate=N,v.pointLights.needsUpdate=N,v.pointLightShadows.needsUpdate=N,v.spotLights.needsUpdate=N,v.spotLightShadows.needsUpdate=N,v.rectAreaLights.needsUpdate=N,v.hemisphereLights.needsUpdate=N}function Lg(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return V},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(v,N,k){const B=G.get(v);B.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),G.get(v.texture).__webglTexture=N,G.get(v.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:k,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,N){const k=G.get(v);k.__webglFramebuffer=N,k.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(v,N=0,k=0){W=v,q=N,V=k;let B=null,z=!1,me=!1;if(v){const pe=G.get(v);if(pe.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(P.FRAMEBUFFER,pe.__webglFramebuffer),ie.copy(v.viewport),_e.copy(v.scissor),ze=v.scissorTest,g.viewport(ie),g.scissor(_e),g.setScissorTest(ze),J=-1;return}else if(pe.__webglFramebuffer===void 0)Y.setupRenderTarget(v);else if(pe.__hasExternalTextures)Y.rebindTextures(v,G.get(v.texture).__webglTexture,G.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Be=v.depthTexture;if(pe.__boundDepthTexture!==Be){if(Be!==null&&G.has(Be)&&(v.width!==Be.image.width||v.height!==Be.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(v)}}const Ee=v.texture;(Ee.isData3DTexture||Ee.isDataArrayTexture||Ee.isCompressedArrayTexture)&&(me=!0);const Ae=G.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ae[N])?B=Ae[N][k]:B=Ae[N],z=!0):v.samples>0&&Y.useMultisampledRTT(v)===!1?B=G.get(v).__webglMultisampledFramebuffer:Array.isArray(Ae)?B=Ae[k]:B=Ae,ie.copy(v.viewport),_e.copy(v.scissor),ze=v.scissorTest}else ie.copy(Me).multiplyScalar(ne).floor(),_e.copy(ut).multiplyScalar(ne).floor(),ze=He;if(k!==0&&(B=H),g.bindFramebuffer(P.FRAMEBUFFER,B)&&g.drawBuffers(v,B),g.viewport(ie),g.scissor(_e),g.setScissorTest(ze),z){const pe=G.get(v.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+N,pe.__webglTexture,k)}else if(me){const pe=N;for(let Ee=0;Ee<v.textures.length;Ee++){const Ae=G.get(v.textures[Ee]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+Ee,Ae.__webglTexture,k,pe)}}else if(v!==null&&k!==0){const pe=G.get(v.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,pe.__webglTexture,k)}J=-1},this.readRenderTargetPixels=function(v,N,k,B,z,me,ve,pe=0){if(!(v&&v.isWebGLRenderTarget)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ee=G.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ve!==void 0&&(Ee=Ee[ve]),Ee){g.bindFramebuffer(P.FRAMEBUFFER,Ee);try{const Ae=v.textures[pe],Be=Ae.format,Ye=Ae.type;if(v.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+pe),!E.textureFormatReadable(Be)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!E.textureTypeReadable(Ye)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=v.width-B&&k>=0&&k<=v.height-z&&P.readPixels(N,k,B,z,he.convert(Be),he.convert(Ye),me)}finally{const Ae=W!==null?G.get(W).__webglFramebuffer:null;g.bindFramebuffer(P.FRAMEBUFFER,Ae)}}},this.readRenderTargetPixelsAsync=async function(v,N,k,B,z,me,ve,pe=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ee=G.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ve!==void 0&&(Ee=Ee[ve]),Ee)if(N>=0&&N<=v.width-B&&k>=0&&k<=v.height-z){g.bindFramebuffer(P.FRAMEBUFFER,Ee);const Ae=v.textures[pe],Be=Ae.format,Ye=Ae.type;if(v.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+pe),!E.textureFormatReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!E.textureTypeReadable(Ye))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Re=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,Re),P.bufferData(P.PIXEL_PACK_BUFFER,me.byteLength,P.STREAM_READ),P.readPixels(N,k,B,z,he.convert(Be),he.convert(Ye),0);const st=W!==null?G.get(W).__webglFramebuffer:null;g.bindFramebuffer(P.FRAMEBUFFER,st);const _t=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await eu(P,_t,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,Re),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,me),P.deleteBuffer(Re),P.deleteSync(_t),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,N=null,k=0){const B=Math.pow(2,-k),z=Math.floor(v.image.width*B),me=Math.floor(v.image.height*B),ve=N!==null?N.x:0,pe=N!==null?N.y:0;Y.setTexture2D(v,0),P.copyTexSubImage2D(P.TEXTURE_2D,k,0,0,ve,pe,z,me),g.unbindTexture()},this.copyTextureToTexture=function(v,N,k=null,B=null,z=0,me=0){let ve,pe,Ee,Ae,Be,Ye,Re,st,_t;const mt=v.isCompressedTexture?v.mipmaps[me]:v.image;if(k!==null)ve=k.max.x-k.min.x,pe=k.max.y-k.min.y,Ee=k.isBox3?k.max.z-k.min.z:1,Ae=k.min.x,Be=k.min.y,Ye=k.isBox3?k.min.z:0;else{const xt=Math.pow(2,-z);ve=Math.floor(mt.width*xt),pe=Math.floor(mt.height*xt),v.isDataArrayTexture?Ee=mt.depth:v.isData3DTexture?Ee=Math.floor(mt.depth*xt):Ee=1,Ae=0,Be=0,Ye=0}B!==null?(Re=B.x,st=B.y,_t=B.z):(Re=0,st=0,_t=0);const at=he.convert(N.format),Dt=he.convert(N.type);let xe;N.isData3DTexture?(Y.setTexture3D(N,0),xe=P.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(Y.setTexture2DArray(N,0),xe=P.TEXTURE_2D_ARRAY):(Y.setTexture2D(N,0),xe=P.TEXTURE_2D),g.activeTexture(P.TEXTURE0),g.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,N.flipY),g.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),g.pixelStorei(P.UNPACK_ALIGNMENT,N.unpackAlignment);const Vt=g.getParameter(P.UNPACK_ROW_LENGTH),et=g.getParameter(P.UNPACK_IMAGE_HEIGHT),$t=g.getParameter(P.UNPACK_SKIP_PIXELS),dn=g.getParameter(P.UNPACK_SKIP_ROWS),Nn=g.getParameter(P.UNPACK_SKIP_IMAGES);g.pixelStorei(P.UNPACK_ROW_LENGTH,mt.width),g.pixelStorei(P.UNPACK_IMAGE_HEIGHT,mt.height),g.pixelStorei(P.UNPACK_SKIP_PIXELS,Ae),g.pixelStorei(P.UNPACK_SKIP_ROWS,Be),g.pixelStorei(P.UNPACK_SKIP_IMAGES,Ye);const Si=v.isDataArrayTexture||v.isData3DTexture,ot=N.isDataArrayTexture||N.isData3DTexture;if(v.isDepthTexture){const xt=G.get(v),Fn=G.get(N),ct=G.get(xt.__renderTarget),On=G.get(Fn.__renderTarget);g.bindFramebuffer(P.READ_FRAMEBUFFER,ct.__webglFramebuffer),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,On.__webglFramebuffer);for(let Ei=0;Ei<Ee;Ei++)Si&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,G.get(v).__webglTexture,z,Ye+Ei),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,G.get(N).__webglTexture,me,_t+Ei)),P.blitFramebuffer(Ae,Be,ve,pe,Re,st,ve,pe,P.DEPTH_BUFFER_BIT,P.NEAREST);g.bindFramebuffer(P.READ_FRAMEBUFFER,null),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(z!==0||v.isRenderTargetTexture||G.has(v)){const xt=G.get(v),Fn=G.get(N);g.bindFramebuffer(P.READ_FRAMEBUFFER,$),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,O);for(let ct=0;ct<Ee;ct++)Si?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,xt.__webglTexture,z,Ye+ct):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,xt.__webglTexture,z),ot?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Fn.__webglTexture,me,_t+ct):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Fn.__webglTexture,me),z!==0?P.blitFramebuffer(Ae,Be,ve,pe,Re,st,ve,pe,P.COLOR_BUFFER_BIT,P.NEAREST):ot?P.copyTexSubImage3D(xe,me,Re,st,_t+ct,Ae,Be,ve,pe):P.copyTexSubImage2D(xe,me,Re,st,Ae,Be,ve,pe);g.bindFramebuffer(P.READ_FRAMEBUFFER,null),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else ot?v.isDataTexture||v.isData3DTexture?P.texSubImage3D(xe,me,Re,st,_t,ve,pe,Ee,at,Dt,mt.data):N.isCompressedArrayTexture?P.compressedTexSubImage3D(xe,me,Re,st,_t,ve,pe,Ee,at,mt.data):P.texSubImage3D(xe,me,Re,st,_t,ve,pe,Ee,at,Dt,mt):v.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,me,Re,st,ve,pe,at,Dt,mt.data):v.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,me,Re,st,mt.width,mt.height,at,mt.data):P.texSubImage2D(P.TEXTURE_2D,me,Re,st,ve,pe,at,Dt,mt);g.pixelStorei(P.UNPACK_ROW_LENGTH,Vt),g.pixelStorei(P.UNPACK_IMAGE_HEIGHT,et),g.pixelStorei(P.UNPACK_SKIP_PIXELS,$t),g.pixelStorei(P.UNPACK_SKIP_ROWS,dn),g.pixelStorei(P.UNPACK_SKIP_IMAGES,Nn),me===0&&N.generateMipmaps&&P.generateMipmap(xe),g.unbindTexture()},this.initRenderTarget=function(v){G.get(v).__webglFramebuffer===void 0&&Y.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?Y.setTextureCube(v,0):v.isData3DTexture?Y.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?Y.setTexture2DArray(v,0):Y.setTexture2D(v,0),g.unbindTexture()},this.resetState=function(){q=0,V=0,W=null,g.reset(),ge.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return sn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ze._getUnpackColorSpace()}}const Bl={type:"change"},Ua={type:"start"},zl={type:"end"},Nr=new fr,Gl=new Ln,lm=Math.cos(70*iu.DEG2RAD),bt=new U,Bt=2*Math.PI,rt={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Na=1e-6;class cm extends Wu{constructor(e,t=null){super(e,t),this.state=rt.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Zn.ROTATE,MIDDLE:Zn.DOLLY,RIGHT:Zn.PAN},this.touches={ONE:Jn.ROTATE,TWO:Jn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new Tn,this._lastTargetPosition=new U,this._quat=new Tn().setFromUnitVectors(e.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new rl,this._sphericalDelta=new rl,this._scale=1,this._panOffset=new U,this._rotateStart=new Ne,this._rotateEnd=new Ne,this._rotateDelta=new Ne,this._panStart=new Ne,this._panEnd=new Ne,this._panDelta=new Ne,this._dollyStart=new Ne,this._dollyEnd=new Ne,this._dollyDelta=new Ne,this._dollyDirection=new U,this._mouse=new Ne,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=hm.bind(this),this._onPointerDown=um.bind(this),this._onPointerUp=fm.bind(this),this._onContextMenu=vm.bind(this),this._onMouseWheel=mm.bind(this),this._onKeyDown=gm.bind(this),this._onTouchStart=_m.bind(this),this._onTouchMove=xm.bind(this),this._onMouseDown=dm.bind(this),this._onMouseMove=pm.bind(this),this._interceptControlDown=Mm.bind(this),this._interceptControlUp=Sm.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=""}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Bl),this.update(),this.state=rt.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){const t=this.object.position;bt.copy(t).sub(this.target),bt.applyQuaternion(this._quat),this._spherical.setFromVector3(bt),this.autoRotate&&this.state===rt.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=Bt:n>Math.PI&&(n-=Bt),r<-Math.PI?r+=Bt:r>Math.PI&&(r-=Bt),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=a!=this._spherical.radius}if(bt.setFromSpherical(this._spherical),bt.applyQuaternion(this._quatInverse),t.copy(this.target).add(bt),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=bt.length();a=this._clampDistance(o*this._scale);const c=o-a;this.object.position.addScaledVector(this._dollyDirection,c),this.object.updateMatrixWorld(),s=!!c}else if(this.object.isOrthographicCamera){const o=new U(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const c=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=c!==this.object.zoom;const l=new U(this._mouse.x,this._mouse.y,0);l.unproject(this.object),this.object.position.sub(l).add(o),this.object.updateMatrixWorld(),a=bt.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(Nr.origin.copy(this.object.position),Nr.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Nr.direction))<lm?this.object.lookAt(this.target):(Gl.setFromNormalAndCoplanarPoint(this.object.up,this.target),Nr.intersectPlane(Gl,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>Na||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Na||this._lastTargetPosition.distanceToSquared(this.target)>Na?(this.dispatchEvent(Bl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?Bt/60*this.autoRotateSpeed*e:Bt/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){bt.setFromMatrixColumn(t,0),bt.multiplyScalar(-e),this._panOffset.add(bt)}_panUp(e,t){this.screenSpacePanning===!0?bt.setFromMatrixColumn(t,1):(bt.setFromMatrixColumn(t,0),bt.crossVectors(this.object.up,bt)),bt.multiplyScalar(e),this._panOffset.add(bt)}_pan(e,t){const n=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;bt.copy(r).sub(this.target);let s=bt.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*s/n.clientHeight,this.object.matrix),this._panUp(2*t*s/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),r=e-n.left,s=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(s/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Bt*this._rotateDelta.x/t.clientHeight),this._rotateUp(Bt*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,s=Math.sqrt(n*n+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),r=.5*(e.pageX+n.x),s=.5*(e.pageY+n.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Bt*this._rotateDelta.x/t.clientHeight),this._rotateUp(Bt*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,s=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Ne,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function um(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function hm(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function fm(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(zl),this.state=rt.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function dm(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case Zn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=rt.DOLLY;break;case Zn.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=rt.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=rt.ROTATE}break;case Zn.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=rt.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=rt.PAN}break;default:this.state=rt.NONE}this.state!==rt.NONE&&this.dispatchEvent(Ua)}function pm(i){switch(this.state){case rt.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case rt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case rt.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function mm(i){this.enabled===!1||this.enableZoom===!1||this.state!==rt.NONE||(i.preventDefault(),this.dispatchEvent(Ua),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(zl))}function gm(i){this.enabled!==!1&&this._handleKeyDown(i)}function _m(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Jn.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=rt.TOUCH_ROTATE;break;case Jn.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=rt.TOUCH_PAN;break;default:this.state=rt.NONE}break;case 2:switch(this.touches.TWO){case Jn.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=rt.TOUCH_DOLLY_PAN;break;case Jn.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=rt.TOUCH_DOLLY_ROTATE;break;default:this.state=rt.NONE}break;default:this.state=rt.NONE}this.state!==rt.NONE&&this.dispatchEvent(Ua)}function xm(i){switch(this._trackPointer(i),this.state){case rt.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case rt.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case rt.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case rt.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=rt.NONE}}function vm(i){this.enabled!==!1&&i.preventDefault()}function Mm(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Sm(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Em(i){const t=te.useRef(null),[n,r]=te.useState({w:0,h:0}),s=te.useRef(null),a=te.useRef(null),o=te.useRef(null),c=te.useCallback((l,h)=>{r(p=>p.w===l&&p.h===h?p:{w:l,h})},[]);return te.useLayoutEffect(()=>{const l=t.current;if(!l||l===o.current)return;const h=l.getBoundingClientRect();(h.width>0||h.height>0)&&(o.current=l,c(h.width,h.height))}),te.useEffect(()=>{var p;const l=t.current;if(l===a.current||((p=s.current)==null||p.disconnect(),s.current=null,a.current=l,!l))return;const h=new ResizeObserver(u=>{for(const d of u)c(d.contentRect.width,d.contentRect.height)});s.current=h,h.observe(l)}),te.useEffect(()=>()=>{var l;return(l=s.current)==null?void 0:l.disconnect()},[]),{ref:t,size:n}}const Fa="camera-state",Vl=new Map,ym=new Map;function Hl(i){let e=Vl.get(i);return e||(e=new EventTarget,Vl.set(i,e)),e}function bm(i,e,t){ym.set(i,t),Hl(i).dispatchEvent(new CustomEvent(Fa,{detail:{state:t,sourceId:e}}))}function Tm(i,e,t){const n=Hl(i),r=s=>{const a=s.detail;a.sourceId!==e&&t(a.state)};return n.addEventListener(Fa,r),()=>n.removeEventListener(Fa,r)}function Am(){return typeof crypto<"u"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now()}-${Math.random().toString(36).slice(2)}`}const kl=16,jt=new Map,Fr=new Set;let Oa=!1;function wm(){if(Oa)return;Oa=!0;const i=()=>{Fr.clear(),Oa=!1};typeof requestAnimationFrame=="function"?requestAnimationFrame(i):queueMicrotask(i)}function Wl(i){Fr.add(i),wm()}function Rm(i){if(!(jt.size<=kl))for(const e of Array.from(jt.keys())){if(jt.size<=kl)break;if(e===i||Fr.has(e))continue;const t=jt.get(e);jt.delete(e),t==null||t.park()}}function Or(i,e){jt.delete(i),jt.set(i,{park:e}),Wl(i),Rm(i)}function Xl(i){const e=jt.get(i);e&&(jt.delete(i),jt.set(i,e),Wl(i))}function ql(i){jt.delete(i),Fr.delete(i)}const Cm=1200;function Yl(i){return typeof i=="string"&&i!=="data:,"&&i.startsWith("data:image/")&&i.length>100}const $l=.05;function Kl(i,e){e==="turntable"?(i.minPolarAngle=$l,i.maxPolarAngle=Math.PI-$l):(i.minPolarAngle=0,i.maxPolarAngle=Math.PI),i.update()}function Br(i){const{background:e,fov:t=50,near:n=.01,far:r=1e3,sync:s=null,showAxes:a=!1,showPlanes:o=!1,cameraMode:c="orbital",opaqueBackground:l=!1,onFrame:h}=i,{ref:p,size:u}=Em(),d=te.useRef(null),_=te.useRef(null),M=te.useRef(null),m=te.useRef(null),f=te.useRef(null),A=te.useRef(null),w=te.useRef(null),S=te.useRef([]),T=te.useRef(null),b=te.useRef(!1),R=te.useRef(s),x=te.useRef(a),y=te.useRef(o),D=te.useRef(c),C=te.useRef(h),L=te.useRef();L.current||(L.current=Am());const H=te.useRef(!1),$=te.useRef(!1),O=te.useRef(null),q=te.useRef(u),V=te.useRef(e),W=te.useRef(l),[J,j]=te.useState(null),ie=te.useRef(null),_e=te.useRef(!1),ze=te.useRef(null),[nt,qe]=te.useState(!1),Z=te.useRef(!1),se=te.useRef(null);te.useEffect(()=>{C.current=h},[h]);const ne=te.useCallback(le=>{if(Z.current===le)return;Z.current=le,qe(le);const we=f.current;we&&(we.enableZoom=le)},[]),be=te.useCallback(()=>{O.current!=null&&(window.clearTimeout(O.current),O.current=null)},[]),Ie=te.useCallback(()=>{const le=_.current;le&&(le.dispose(),le.forceContextLoss(),_.current=null)},[]),Me=te.useCallback(()=>{var Ge;const le=_.current;if(!le||H.current)return;if(!_e.current){Or(L.current,Me);return}const we=le.getContext();let ke=!1;if(!we.isContextLost()){const je=M.current,P=m.current;je&&P&&le.render(je,P);try{const We=le.domElement.toDataURL("image/png");if(Yl(We)){ke=!0;const Ke=new Image;Ke.onload=()=>{j(We),ie.current=We},Ke.src=We}}catch{}}if(!ke&&ie.current==null){Or(L.current,Me);return}(Ge=ze.current)==null||Ge.loseContext(),H.current=!0,ql(L.current),be()},[be]),ut=te.useCallback(()=>{be(),O.current=window.setTimeout(()=>{O.current=null,$.current||Me()},Cm)},[be,Me]),He=te.useCallback(()=>{const le=M.current;if(!le||(A.current&&(le.remove(A.current),A.current.geometry.dispose(),A.current.material.dispose(),A.current=null),w.current&&(le.remove(w.current),w.current.geometry.dispose(),w.current.material.dispose(),w.current=null),!x.current))return;const we=T.current,ke=we?Math.max(new U(...we.max).sub(new U(...we.min)).length()*.5,.001):1,Ge=new ku(ke*1.2);le.add(Ge),A.current=Ge;const je=new Hu(ke*2,10);le.add(je),w.current=je},[]),tt=te.useCallback(()=>{const le=M.current;if(!le)return;for(const P of S.current)le.remove(P),P.geometry.dispose(),P.material.dispose();if(S.current=[],!y.current)return;const we=T.current,Ge=(we?Math.max(new U(...we.max).sub(new U(...we.min)).length()*.5,.001):1)*2,je=[{color:3900150,rotate:()=>{}},{color:2278750,rotate:P=>P.rotateX(-Math.PI/2)},{color:15680580,rotate:P=>P.rotateY(Math.PI/2)}];for(const P of je){const We=new qt(new Oi(Ge,Ge),new _a({color:P.color,transparent:!0,opacity:.06,side:Ht,depthWrite:!1}));P.rotate(We),le.add(We),S.current.push(We)}},[]),Je=te.useCallback(()=>{var le;if(!H.current){Xl(L.current);return}(le=ze.current)==null||le.restoreContext(),H.current=!1,Or(L.current,Me)},[Me]),Ue=te.useCallback(()=>{var Ge;H.current&&Je();const le=_.current,we=M.current,ke=m.current;le&&we&&ke&&(le.render(we,ke),(Ge=C.current)==null||Ge.call(C,le.domElement)),Xl(L.current),ut()},[Je,ut]),dt=te.useCallback(le=>{T.current=le,_e.current=!0;const we=m.current,ke=f.current;if(!we||!ke)return;const Ge=new U(...le.min),je=new U(...le.max),P=Ge.clone().add(je).multiplyScalar(.5),We=Math.max(je.clone().sub(Ge).length()*.5,.001),Ke=we.fov*Math.PI/180,E=We/Math.sin(Ke/2)*1.15;we.near=Math.max(E/1e3,1e-4),we.far=E*10+We*10,we.up.set(0,1,0),we.position.copy(P).add(new U(1,.75,1).normalize().multiplyScalar(E)),we.lookAt(P),we.updateProjectionMatrix(),ke.target.copy(P),ke.update(),He(),tt(),Ue()},[Ue,He,tt]);return te.useEffect(()=>{const le=d.current;if(!le)return;const we=new om({canvas:le,antialias:!0,alpha:!0});we.setPixelRatio(Math.min(window.devicePixelRatio,2)),we.setClearColor(V.current,W.current?1:0);const ke=q.current;ke.w>0&&ke.h>0&&we.setSize(ke.w,ke.h,!1),_.current=we;const Ge=we.getContext();ze.current=(Ge==null?void 0:Ge.getExtension("WEBGL_lose_context"))??null;const je=new gu;M.current=je;const P=new Yt(t,1,n,r);m.current=P;const We=new cm(P,le);We.enableDamping=!1,We.enableZoom=Z.current,Kl(We,D.current),f.current=We,se.current={position:P.position.toArray(),target:We.target.toArray(),zoom:P.zoom};const Ke=()=>{Ue();const X=R.current;X&&!b.current&&bm(X.groupId,L.current,{position:P.position.toArray(),target:We.target.toArray(),zoom:P.zoom})};We.addEventListener("change",Ke);const E=()=>{$.current=!0,Ue()},g=()=>{$.current=!1,ut()};We.addEventListener("start",E),We.addEventListener("end",g);const F=()=>{if(T.current){dt(T.current);return}const X=se.current,K=m.current,oe=f.current;X&&K&&oe&&(K.position.fromArray(X.position),oe.target.fromArray(X.target),K.zoom=X.zoom,K.updateProjectionMatrix(),oe.update(),Ue())};le.addEventListener("dblclick",F);const G=X=>{const K=p.current;K&&ne(K.contains(X.target))},Y=X=>{const K=p.current;K&&(K.contains(X.target)||ne(!1))};document.addEventListener("pointerdown",G,!0),document.addEventListener("wheel",Y,{capture:!0,passive:!0});const re=X=>{X.preventDefault()},ae=()=>{H.current=!1,Ue(),j(null),ie.current=null};return le.addEventListener("webglcontextlost",re,!1),le.addEventListener("webglcontextrestored",ae,!1),Or(L.current,Me),()=>{le.removeEventListener("dblclick",F),document.removeEventListener("pointerdown",G,!0),document.removeEventListener("wheel",Y,!0),le.removeEventListener("webglcontextlost",re,!1),le.removeEventListener("webglcontextrestored",ae,!1),We.removeEventListener("start",E),We.removeEventListener("end",g),We.removeEventListener("change",Ke),We.dispose(),be(),ql(L.current),Ie(),ze.current=null,A.current&&(A.current.geometry.dispose(),A.current.material.dispose(),A.current=null),w.current&&(w.current.geometry.dispose(),w.current.material.dispose(),w.current=null);for(const X of S.current)X.geometry.dispose(),X.material.dispose();S.current=[],M.current=null,m.current=null,f.current=null}},[]),te.useEffect(()=>{R.current=s},[s]),te.useEffect(()=>{if(!s)return;const le=m.current,we=f.current;if(!(!le||!we))return Tm(s.groupId,L.current,ke=>{b.current=!0,le.position.fromArray(ke.position),we.target.fromArray(ke.target),le.zoom=ke.zoom,le.updateProjectionMatrix(),we.update(),b.current=!1})},[s==null?void 0:s.groupId]),te.useEffect(()=>{x.current=a,He(),Ue()},[a]),te.useEffect(()=>{y.current=o,tt(),Ue()},[o]),te.useEffect(()=>{D.current=c;const le=f.current;le&&Kl(le,c),Ue()},[c]),te.useEffect(()=>{V.current=e,W.current=l;const le=_.current;le&&(le.setClearColor(e,l?1:0),Ue())},[e,l]),te.useEffect(()=>{q.current=u;const le=m.current;le&&u.w>0&&u.h>0&&(le.aspect=u.w/u.h,le.updateProjectionMatrix());const we=_.current;!we||u.w===0||u.h===0||(we.setSize(u.w,u.h,!1),Ue())},[u.w,u.h]),{containerRef:p,canvasRef:d,requestRender:Ue,fitToBounds:dt,refs:{renderer:_,scene:M,camera:m,controls:f},cachedImageUrl:J,active:nt}}function zr({handle:i,className:e}){const[t,n]=te.useState(null),r=Yl(i.cachedImageUrl)&&i.cachedImageUrl!==t;return Pe.jsxs("div",{ref:i.containerRef,className:e??"relative h-full w-full",children:[Pe.jsx("canvas",{ref:i.canvasRef,className:"block h-full w-full rounded"}),r&&Pe.jsx("img",{src:i.cachedImageUrl,alt:"","aria-hidden":!0,onError:()=>n(i.cachedImageUrl),className:"pointer-events-none absolute inset-0 block h-full w-full rounded object-fill"}),i.active&&Pe.jsx("div",{"aria-hidden":!0,className:"pointer-events-none absolute inset-0 rounded border border-accent/50"})]})}function Pm(i,e,t){return[i[0]+(e[0]-i[0])*t,i[1]+(e[1]-i[1])*t,i[2]+(e[2]-i[2])*t]}function Dm(i){const e=new Uint8Array(768);for(let t=0;t<256;t++){const r=t/255*(i.length-1),s=Math.floor(r),a=Math.min(s+1,i.length-1),o=r-s,[c,l,h]=Pm(i[s],i[a],o);e[t*3]=Math.round(c),e[t*3+1]=Math.round(l),e[t*3+2]=Math.round(h)}return e}const Zl={viridis:[[68,1,84],[59,82,139],[33,145,140],[94,201,98],[253,231,37]],plasma:[[13,8,135],[126,3,168],[204,71,120],[248,149,64],[240,249,33]],"red-green":[[215,25,28],[255,255,255],[26,150,65]],"red-blue":[[215,25,28],[255,255,255],[44,123,182]]},Jl=new Map;function Ql(i){let e=Jl.get(i);if(!e){const t=Zl[i]??Zl.viridis;e=Dm(t),Jl.set(i,e)}return e}const Lm=["#0969da","#d29922","#3fb950","#f85149","#c678dd","#56d4dd"];function Vi(i,e,t,n="viridis",r){const{stride:s=1,offset:a=0,out:o}=r??{},c=o??new Float32Array(e*3),l=Ql(n),[h,p]=t,u=p-h||1;for(let d=0;d<e;d++){const _=i[d*s+a],M=Math.max(0,Math.min(1,(_-h)/u)),m=Math.min(255,Math.max(0,Math.round(M*255)));c[d*3]=l[m*3]/255,c[d*3+1]=l[m*3+1]/255,c[d*3+2]=l[m*3+2]/255}return c}function Im(i){const e=parseInt(i.replace("#",""),16);return[(e>>16&255)/255,(e>>8&255)/255,(e&255)/255]}const jl=Lm.map(Im);function Um(i,e,t){const{stride:n=1,offset:r=0,out:s}=t??{},a=s??new Float32Array(e*3);for(let o=0;o<e;o++){const c=Math.max(0,Math.round(i[o*n+r])),[l,h,p]=jl[c%jl.length];a[o*3]=l,a[o*3+1]=h,a[o*3+2]=p}return a}function ec(i,e,t,n,r){const s=new Float32Array(e*3);for(let a=0;a<e;a++)s[a*3]=i[a*t+n],s[a*3+1]=i[a*t+n+1],s[a*3+2]=i[a*t+n+2];return s}const tc={xyz:3,xyzc:4,xyzrgb:6},Nm={dark:856343,light:16185594};function Fm(i,e){return i==="rgb"?e==="xyzrgb"?"rgb":e==="xyzc"?"category":"height":i==="category"?e==="xyzc"?"category":e==="xyzrgb"?"rgb":"height":i==="height"?"height":e==="xyzrgb"?"rgb":e==="xyzc"?"category":"height"}function Om(i,e,t){const n=tc[e];if(n===3)return i.subarray(0,t*3);const r=new Float32Array(t*3);for(let s=0;s<t;s++)r[s*3]=i[s*n],r[s*3+1]=i[s*n+1],r[s*3+2]=i[s*n+2];return r}function nc(i,e,t,n,r){const s=tc[e],a=Fm(r,e);return a==="rgb"?ec(i,t,s,3):a==="category"?Um(i,t,{stride:s,offset:3}):Vi(i,t,[n.min[2],n.max[2]],"viridis",{stride:s,offset:2})}function Bm({data:i,channels:e,nPoints:t,bounds:n,colorMode:r,pointSize:s,pointSizeMode:a="screen",background:o,className:c,sync:l=null,onFrame:h,showAxes:p=!1,showPlanes:u=!1,cameraMode:d="orbital",overrideColors:_=null}){const M=Br({background:Nm[o],sync:l,showAxes:p,showPlanes:u,cameraMode:d,onFrame:h}),{requestRender:m,fitToBounds:f,refs:A}=M,w=te.useRef(null),S=te.useRef(null),T=te.useRef(null),b=te.useMemo(()=>Om(i,e,t),[i,e,t]);return te.useEffect(()=>{var L,H;const R=A.scene.current;if(!R)return;w.current&&(R.remove(w.current),(L=S.current)==null||L.dispose(),(H=T.current)==null||H.dispose());const x=new wt;x.setAttribute("position",new gt(b,3));const y=_??nc(i,e,t,n,r);x.setAttribute("color",new gt(y,3));const D=new Ea({size:s,sizeAttenuation:a==="world",vertexColors:!0}),C=new Au(x,D);R.add(C),S.current=x,T.current=D,w.current=C,f(n)},[b,i,e,t]),te.useEffect(()=>{const R=S.current;if(!R)return;const x=_??nc(i,e,t,n,r),y=R.getAttribute("color");y.copyArray(x),y.needsUpdate=!0,m()},[r,_]),te.useEffect(()=>{const R=w.current,x=T.current;if(!R||!x)return;const y=a==="world";if(x.sizeAttenuation!==y){const D=new Ea({size:s,sizeAttenuation:y,vertexColors:!0});R.material=D,x.dispose(),T.current=D}else x.size=s,x.needsUpdate=!0;m()},[s,a]),te.useEffect(()=>()=>{var R,x;(R=S.current)==null||R.dispose(),(x=T.current)==null||x.dispose()},[]),Pe.jsx(zr,{handle:M,className:c})}function zm(i,e,t){const n=new Float32Array(t);for(let r=0;r<t;r++)n[r]=(i[r]??0)-(e[r]??0);return n}function Gm(i,e,t){const n=new Float32Array(t);for(let r=0;r<t;r++){const s=(i[r*3]??0)-(e[r*3]??0),a=(i[r*3+1]??0)-(e[r*3+1]??0),o=(i[r*3+2]??0)-(e[r*3+2]??0);n[r]=Math.sqrt(s*s+a*a+o*o)}return n}function Vm(i){let e=0;for(let t=0;t<i.length;t++){const n=Math.abs(i[t]??0);n>e&&(e=n)}return e||1e-6}function Ba(i,e){const t=Vm(i);return e==="red-green"?[-t,t]:[0,t]}function Hm(i){const e=new Float32Array(i.length);for(let t=0;t<i.length;t++)e[t]=Math.abs(i[t]);return e}function za(i,e,t){const n=Ba(i,t);return{colors:km(i,e,n,t),domain:n}}function km(i,e,t,n){const r=n==="viridis"?Hm(i):i;return Vi(r,e,t,n)}function Wm(){const t=zm([1,2,3],[1,0,6],3);if(t[0]!==0||t[1]!==2||t[2]!==-3)throw new Error("diff.ts: computeDelta invariant violated");const s=Gm([0,0,0,3,4,0],[0,0,0,0,0,0],2);if(s[0]!==0||Math.abs(s[1]-5)>1e-6)throw new Error("diff.ts: computeDisplacementMagnitude invariant violated");const[a,o]=Ba(t,"red-green");if(a!==-3||o!==3)throw new Error("diff.ts: red-green domain must be symmetric around zero");const[c,l]=Ba(t,"viridis");if(c!==0||l!==3)throw new Error("diff.ts: viridis domain must be [0, maxAbs]");const{colors:h,domain:p}=za(t,3,"red-green");if(h.length!==9||p[0]!==-3||p[1]!==3)throw new Error("diff.ts: diffColors invariant violated");const u=za(new Float32Array([0]),1,"red-green").colors;if(Math.abs(u[0]-1)>.02||Math.abs(u[1]-1)>.02||Math.abs(u[2]-1)>.02)throw new Error("diff.ts: red-green zero must map to white (neutral)");const d=za(new Float32Array([-3,0,3]),3,"viridis").colors,_=Math.abs(d[0]-d[6])<1e-6&&Math.abs(d[1]-d[7])<1e-6&&Math.abs(d[2]-d[8])<1e-6,M=Math.abs(d[0]-d[3])>.001||Math.abs(d[1]-d[4])>.001||Math.abs(d[2]-d[5])>.001;if(!_||!M)throw new Error("diff.ts: viridis magnitude must color ±v identically and distinctly from 0 (sign-clamp regression)")}Wm();function Xm(i){return i?Object.keys(i):[]}function qm(i){let e=1/0,t=-1/0;for(let n=0;n<i.length;n++){const r=i[n];r<e&&(e=r),r>t&&(t=r)}return!Number.isFinite(e)||!Number.isFinite(t)?[0,1]:[e,t]}function ic(i,e,t){const n=Xm(i);if(n.length===0)return{name:null,values:null,range:null};const r=e&&n.includes(e)?e:n[0],s=i[r],a=t==null?void 0:t.find(c=>c.name===r),o=a?[a.min,a.max]:qm(s);return{name:r,values:s,range:o}}function Gr({label:i,isDraggable:e,onDragStart:t}){return Pe.jsxs("span",{className:`absolute bottom-1 left-1 z-10 rounded bg-bg/80 px-1 py-0.5 text-[10px] text-fg-muted backdrop-blur-sm flex items-center gap-1${e?" cairn-drag-grip":""}`,draggable:e,onDragStart:t,style:{cursor:e?"grab":void 0},children:[e&&Pe.jsx("i",{className:"fa-solid fa-grip-vertical text-[8px] opacity-50","aria-hidden":"true"}),i]})}function Ym({item:i,view:e,sync:t,label:n,isDraggable:r,onDragStart:s,onFrame:a}){if(!i)return Pe.jsx("div",{className:"flex h-full w-full items-center justify-center text-sm text-fg-muted",children:"no point cloud logged yet"});const{arrays:o,meta:c}=i;return Pe.jsxs("div",{className:"relative flex h-full w-full overflow-hidden rounded bg-bg",children:[Pe.jsx("div",{className:"min-w-0 flex-1",children:Pe.jsx(Bm,{data:o.data,channels:c.channels,nPoints:c.n_points,bounds:c.bounds,colorMode:e.colorMode,pointSize:e.pointSize,pointSizeMode:e.pointSizeMode,background:e.background,showAxes:e.showAxes,showPlanes:e.showPlanes,cameraMode:e.cameraMode,sync:t,onFrame:a})}),Pe.jsx(Gr,{label:n,isDraggable:r,onDragStart:s})]})}const $m={dark:856343,light:16185594},rc=7252223,Km=0;function sc(i,e,t,n=!1){return i==="face-colors"&&!n?e?"vertex-colors":t?"values":"solid":i==="vertex-colors"&&!e?t?"values":"solid":i==="values"&&!t?e?"vertex-colors":"solid":i}function Zm(i,e,t,n){const s=(t>0?n.length/t:3)===4?4:3,a=new Float32Array(t*9),o=new Float32Array(t*3*s);for(let c=0;c<t;c++){const l=n[c*s],h=n[c*s+1],p=n[c*s+2],u=s===4?n[c*s+3]:1;for(let d=0;d<3;d++){const _=e[c*3+d],M=(c*3+d)*3;a[M]=i[_*3],a[M+1]=i[_*3+1],a[M+2]=i[_*3+2];const m=(c*3+d)*s;o[m]=l,o[m+1]=h,o[m+2]=p,s===4&&(o[m+3]=u)}}return{outPositions:a,outColors:o,channels:s}}function Jm(i){let e=1/0,t=-1/0;for(let n=0;n<i.length;n++){const r=i[n];r<e&&(e=r),r>t&&(t=r)}return!Number.isFinite(e)||!Number.isFinite(t)?[0,1]:[e,t]}function ac(i,e,t,n,r){if(i==="vertex-colors"&&r)return ec(r,e,3,0);if(i==="values"&&t){const s=n??Jm(t);return Vi(t,e,s,"viridis")}return null}function Qm({positions:i,faces:e,nVertices:t,nFaces:n,values:r=null,valueRange:s=null,colors:a=null,faceColors:o=null,normals:c=null,bounds:l,colorMode:h,shading:p,wireframe:u,doubleSided:d,background:_,className:M,sync:m=null,onFrame:f,showAxes:A=!1,showPlanes:w=!1,cameraMode:S="orbital"}){const T=Br({background:$m[_],sync:m,showAxes:A,showPlanes:w,cameraMode:S,onFrame:f}),{requestRender:b,fitToBounds:R,refs:x}=T,y=te.useRef(null),D=te.useRef(null),C=te.useRef(null),L=te.useRef(null),H=te.useRef(null),$=te.useRef(null),O=te.useRef([]),q=te.useMemo(()=>sc(h,!!a,!!r,!!o),[h,a,r,o]),V=q==="face-colors"&&!!o;return te.useEffect(()=>{const W=x.scene.current;if(!W)return;const J=new Fu(16777215,3817290,1.1),j=new zu(16777215,1.1);return j.position.set(1,1.6,1.2),W.add(J,j),O.current=[J,j],b(),()=>{W.remove(J,j)}},[]),te.useEffect(()=>{var qe,Z,se,ne;const W=x.scene.current;if(!W)return;y.current&&(W.remove(y.current),(qe=D.current)==null||qe.dispose(),(Z=C.current)==null||Z.dispose()),L.current&&(W.remove(L.current),(se=H.current)==null||se.dispose(),(ne=$.current)==null||ne.dispose());const J=new Iu({color:rc,roughness:.85,metalness:0,flatShading:p==="flat",side:d?Ht:en,polygonOffset:!0,polygonOffsetFactor:1,polygonOffsetUnits:1}),j=new wt;if(V&&o){const{outPositions:be,outColors:Ie,channels:Me}=Zm(i,e,n,o);j.setAttribute("position",new gt(be,3)),j.computeVertexNormals(),j.setAttribute("color",new gt(Ie,Me)),J.vertexColors=!0,Me===4&&(J.transparent=!0)}else{j.setAttribute("position",new gt(i,3)),j.setIndex(new gt(e,1)),c&&c.length===t*3?j.setAttribute("normal",new gt(c,3)):j.computeVertexNormals();const be=ac(q,t,r,s,a);be&&(j.setAttribute("color",new gt(be,3)),J.vertexColors=!0)}const ie=new qt(j,J);W.add(ie),D.current=j,C.current=J,y.current=ie;const _e=new Ru(j),ze=new Ni({color:Km,transparent:!0,opacity:.35}),nt=new Tr(_e,ze);nt.visible=u,W.add(nt),H.current=_e,$.current=ze,L.current=nt,R(l)},[i,e,t,n,c,V,o]),te.useEffect(()=>{const W=D.current,J=C.current;if(!W||!J||V)return;const j=ac(q,t,r,s,a);if(j){let ie=W.getAttribute("color");!ie||ie.count!==t?(ie=new gt(j,3),W.setAttribute("color",ie)):(ie.copyArray(j),ie.needsUpdate=!0),J.vertexColors=!0}else J.vertexColors=!1,J.color.setHex(rc);J.needsUpdate=!0,b()},[q,r,s,a,t,V]),te.useEffect(()=>{const W=C.current;W&&(W.flatShading=p==="flat",W.needsUpdate=!0,b())},[p]),te.useEffect(()=>{const W=C.current;W&&(W.side=d?Ht:en,W.needsUpdate=!0,b())},[d]),te.useEffect(()=>{const W=L.current;W&&(W.visible=u,b())},[u]),te.useEffect(()=>()=>{var W,J,j,ie;(W=D.current)==null||W.dispose(),(J=C.current)==null||J.dispose(),(j=H.current)==null||j.dispose(),(ie=$.current)==null||ie.dispose()},[]),Pe.jsx(zr,{handle:T,className:M})}function jm({item:i,view:e,sync:t,label:n,isDraggable:r,onDragStart:s,onFrame:a,colorRange:o}){if(!i)return Pe.jsx("div",{className:"flex h-full w-full items-center justify-center text-sm text-fg-muted",children:"no mesh logged yet"});const{arrays:c,meta:l}=i,h=ic(c.properties,e.property,l.properties??null),u=sc(e.colorMode,!!c.colors,!!h.values,!!c.faceColors)==="values"?o??h.range:h.range;return Pe.jsxs("div",{className:"relative flex h-full w-full flex-col overflow-hidden rounded bg-bg",children:[Pe.jsx("div",{className:"flex flex-1 min-h-0 overflow-hidden",children:Pe.jsx("div",{className:"min-w-0 flex-1",children:Pe.jsx(Qm,{positions:c.positions,faces:c.faces,nVertices:l.n_vertices,nFaces:l.n_faces,values:h.values,valueRange:u,colors:c.colors,faceColors:c.faceColors,normals:c.normals,bounds:l.bounds,colorMode:e.colorMode,shading:e.shading,wireframe:e.wireframe,doubleSided:e.doubleSided,background:e.background,showAxes:e.showAxes,showPlanes:e.showPlanes,cameraMode:e.cameraMode,sync:t,onFrame:a})})}),Pe.jsxs("div",{className:"pointer-events-none absolute left-1 top-1 z-10 mono rounded bg-bg/80 px-1 py-0.5 text-[10px] text-fg-subtle backdrop-blur-sm",children:[`${l.n_vertices.toLocaleString()} verts · ${l.n_faces.toLocaleString()} faces`,h.name?` · ${h.name}`:""]}),Pe.jsx(Gr,{label:n,isDraggable:r,onDragStart:s})]})}const eg={dark:856343,light:16185594},oc=256;let Hi=null;function tg(){if(Hi!==null)return Hi;try{const e=document.createElement("canvas").getContext("webgl2");if(e){const t=e.getExtension("WEBGL_lose_context");t==null||t.loseContext()}Hi=!!e}catch{Hi=!1}return Hi}function ng({className:i}){return Pe.jsx("div",{className:i??"relative h-full w-full",children:Pe.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center gap-1 rounded bg-bg-hover p-4 text-center",children:[Pe.jsx("div",{className:"text-sm font-semibold text-fg",children:"WebGL2 unavailable"}),Pe.jsx("div",{className:"text-xs text-fg-muted",children:"Volume rendering needs WebGL2 (raymarched 3D textures), which this browser or GPU doesn't support."})]})})}function ig(i,e,t){const n=t-e||1,r=new Uint8Array(i.length);for(let s=0;s<i.length;s++){const a=(i[s]-e)/n;r[s]=Math.max(0,Math.min(255,Math.round(a*255)))}return r}function lc(i){const e=Ql(i),t=new Uint8Array(256*4);for(let r=0;r<256;r++)t[r*4]=e[r*3],t[r*4+1]=e[r*3+1],t[r*4+2]=e[r*3+2],t[r*4+3]=255;const n=new zo(t,256,1,kt,It);return n.minFilter=vt,n.magFilter=vt,n.wrapS=Ft,n.wrapT=Ft,n.needsUpdate=!0,n}const rg=`precision highp float;
...
`;function ag(i,e,t){const[n,r,s]=i,a=s*e[2],o=r*e[1],c=n*e[0],l=t[2],h=t[1],p=t[0];return{scale:[a,o,c],position:[l+a/2,h+o/2,p+c/2],bounds:{min:[l,h,p],max:[l+a,h+o,p+c]}}}function og({data:i,shape:e,spacing:t,origin:n,vmin:r,vmax:s,mode:a,isovalue:o,colormap:c,steps:l,clip:h,background:p,className:u,sync:d=null,onFrame:_,showAxes:M=!1,showPlanes:m=!1,cameraMode:f="orbital"}){const A=Br({background:eg[p],sync:d,showAxes:M,showPlanes:m,cameraMode:f,onFrame:_}),{requestRender:w,fitToBounds:S,refs:T}=A,b=te.useRef(null),R=te.useRef(null),x=te.useRef(null),y=te.useRef(null),D=te.useRef(null);return te.useEffect(()=>{var qe,Z,se,ne;const C=T.scene.current;if(!C)return;b.current&&(C.remove(b.current),(qe=R.current)==null||qe.dispose(),(Z=x.current)==null||Z.dispose(),(se=y.current)==null||se.dispose(),(ne=D.current)==null||ne.dispose());const[L,H,$]=e,O=ig(i,r,s),q=new yo(O,$,H,L);q.format=us,q.type=It,q.minFilter=vt,q.magFilter=vt,q.wrapR=Ft,q.wrapS=Ft,q.wrapT=Ft,q.needsUpdate=!0;const V=lc(c),W={uData:{value:q},uLUT:{value:V},uMode:{value:a==="mip"?0:1},uSteps:{value:l},uIsovalue:{value:o},uClipMin:{value:new U(...h.min)},uClipMax:{value:new U(...h.max)},uTexelSize:{value:new U(1/$,1/H,1/L)}},J=new Jo({glslVersion:Ys,vertexShader:rg,fragmentShader:sg,uniforms:W,side:Lt,transparent:!1}),j=new mi(1,1,1),ie=new qt(j,J),{scale:_e,position:ze,bounds:nt}=ag(e,t,n);ie.scale.set(..._e),ie.position.set(...ze),C.add(ie),b.current=ie,R.current=j,x.current=J,y.current=q,D.current=V,S(nt)},[i,e,t,n,r,s]),te.useEffect(()=>{var H;const C=x.current;if(!C)return;(H=D.current)==null||H.dispose();const L=lc(c);D.current=L,C.uniforms.uLUT.value=L,w()},[c]),te.useEffect(()=>{const C=x.current;if(!C)return;const L=C.uniforms;L.uMode.value=a==="mip"?0:1,L.uSteps.value=l,L.uIsovalue.value=o,L.uClipMin.value.set(...h.min),L.uClipMax.value.set(...h.max),w()},[a,o,l,h]),te.useEffect(()=>()=>{var C,L,H,$;(C=R.current)==null||C.dispose(),(L=x.current)==null||L.dispose(),(H=y.current)==null||H.dispose(),($=D.current)==null||$.dispose()},[]),Pe.jsx(zr,{handle:A,className:u})}function lg(i){return tg()?Pe.jsx(og,{...i}):Pe.jsx(ng,{className:i.className})}function cg({item:i,view:e,sync:t,label:n,isDraggable:r,onDragStart:s,onFrame:a,colorRange:o}){if(!i)return Pe.jsx("div",{className:"flex h-full w-full items-center justify-center text-sm text-fg-muted",children:"no volume logged yet"});const{arrays:c,meta:l}=i,[h,p]=o??[l.vmin,l.vmax];return Pe.jsxs("div",{className:"relative flex h-full w-full flex-col overflow-hidden rounded bg-bg",children:[Pe.jsx("div",{className:"flex flex-1 min-h-0 overflow-hidden",children:Pe.jsx("div",{className:"min-w-0 flex-1 overflow-hidden rounded bg-bg",children:Pe.jsx(lg,{data:c.data,shape:l.shape,spacing:l.spacing,origin:l.origin,vmin:h,vmax:p,mode:e.mode,isovalue:e.isovalue,colormap:e.colormap,steps:e.steps,clip:{min:e.clipMin,max:e.clipMax},background:e.background,showAxes:e.showAxes,showPlanes:e.showPlanes,cameraMode:e.cameraMode,sync:t,onFrame:a})})}),Pe.jsx("div",{className:"pointer-events-none absolute left-1 top-1 z-10 mono rounded bg-bg/80 px-1 py-0.5 text-[10px] text-fg-subtle backdrop-blur-sm",children:`${l.shape.join("×")} · vmin ${l.vmin.toFixed(3)} · vmax ${l.vmax.toFixed(3)}`}),Pe.jsx(Gr,{label:n,isDraggable:r,onDragStart:s})]})}const ug={dark:856343,light:16185594},Ga=[.36,.66,.96],cc=[[0,1],[1,2],[2,3],[3,0],[4,5],[5,6],[6,7],[7,4],[0,4],[1,5],[2,6],[3,7]];function uc(i,e){return i==="value"&&!e?"depth":i}function hg(i,e,t,n,r,s){if(s==="value"&&t)return Vi(t,i,r??[0,1],"viridis");if(s==="depth")return Vi(e,i,[0,Math.max(n,1e-6)],"viridis");const a=new Float32Array(i*3);for(let o=0;o<i;o++)a[o*3]=Ga[0],a[o*3+1]=Ga[1],a[o*3+2]=Ga[2];return a}function fg(i,e,t,n,r){const[s,a]=n,o=[];for(let c=0;c<i;c++){const l=e[c]??0;if(!(l<s||l>a)){if(r&&t){const h=t[c]??0;if(h<r[0]||h>r[1])continue}o.push(c)}}return o}function dg(i,e,t,n){const r=cc.length*2,s=new Float32Array(t.length*r*3),a=new Float32Array(t.length*r*3),o=new Float32Array(8*3);let c=0,l=0;for(const h of t){const p=i[h*3],u=i[h*3+1],d=i[h*3+2],_=e[h*3],M=e[h*3+1],m=e[h*3+2];o[0]=p,o[1]=u,o[2]=d,o[3]=_,o[4]=u,o[5]=d,o[6]=_,o[7]=M,o[8]=d,o[9]=p,o[10]=M,o[11]=d,o[12]=p,o[13]=u,o[14]=m,o[15]=_,o[16]=u,o[17]=m,o[18]=_,o[19]=M,o[20]=m,o[21]=p,o[22]=M,o[23]=m;const f=n[h*3],A=n[h*3+1],w=n[h*3+2];for(const[S,T]of cc)s[c++]=o[S*3],s[c++]=o[S*3+1],s[c++]=o[S*3+2],s[c++]=o[T*3],s[c++]=o[T*3+1],s[c++]=o[T*3+2],a[l++]=f,a[l++]=A,a[l++]=w,a[l++]=f,a[l++]=A,a[l++]=w}return{positions:s,colors:a}}function pg({mins:i,maxs:e,depth:t,values:n,nBoxes:r,bounds:s,maxDepth:a,valueRange:o,colorMode:c,depthRange:l,valueThreshold:h,background:p,className:u,sync:d=null,onVisibleCount:_,onFrame:M,showAxes:m=!1,showPlanes:f=!1,cameraMode:A="orbital",overrideColors:w=null}){const S=Br({background:ug[p],sync:d,showAxes:m,showPlanes:f,cameraMode:A,onFrame:M}),{requestRender:T,fitToBounds:b,refs:R}=S,x=te.useRef(null),y=te.useRef(null),D=te.useRef(null),C=uc(c,!!n);return te.useEffect(()=>{var j,ie;const L=R.scene.current;if(!L)return;const H=fg(r,t,n,l,h??null),$=w??hg(r,t,n,a,o,C),{positions:O,colors:q}=dg(i,e,H,$);x.current&&(L.remove(x.current),(j=y.current)==null||j.dispose(),(ie=D.current)==null||ie.dispose());const V=new wt;V.setAttribute("position",new gt(O,3)),V.setAttribute("color",new gt(q,3));const W=new Ni({vertexColors:!0}),J=new Tr(V,W);L.add(J),y.current=V,D.current=W,x.current=J,T(),_==null||_(H.length,r)},[i,e,t,n,r,l[0],l[1],h==null?void 0:h[0],h==null?void 0:h[1],C,a,o==null?void 0:o[0],o==null?void 0:o[1],w]),te.useEffect(()=>{b(s)},[i,e,r]),te.useEffect(()=>()=>{var L,H;(L=y.current)==null||L.dispose(),(H=D.current)==null||H.dispose()},[]),Pe.jsx(zr,{handle:S,className:u})}function Vr(i,e,t){return Math.min(Math.max(i,e),t)}function mg({item:i,view:e,sync:t,label:n,isDraggable:r,onDragStart:s,onFrame:a,colorRange:o}){const[c,l]=te.useState(null);if(!i)return Pe.jsx("div",{className:"flex h-full w-full items-center justify-center text-sm text-fg-muted",children:"no boxes logged yet"});const{arrays:h,meta:p}=i,u=ic(h.properties,e.property,p.properties??null),d=!!u.values&&!!u.range,_=p.max_depth,M=Vr(e.depthMin??0,0,_),m=Vr(e.depthMax??_,M,_),f=d&&e.valueFilterEnabled&&u.range?[Vr(e.valueMin??u.range[0],u.range[0],u.range[1]),Vr(e.valueMax??u.range[1],u.range[0],u.range[1])]:null,A=uc(e.colorMode,d),w=A==="value"?o??u.range:u.range,S=A==="depth"&&o?o[1]:_;return Pe.jsxs("div",{className:"relative flex h-full w-full flex-col overflow-hidden rounded bg-bg",children:[Pe.jsx("div",{className:"flex flex-1 min-h-0 overflow-hidden",children:Pe.jsx("div",{className:"min-w-0 flex-1",children:Pe.jsx(pg,{mins:h.mins,maxs:h.maxs,depth:h.depth,values:u.values,nBoxes:p.n_boxes,bounds:p.bounds,maxDepth:S,valueRange:w,colorMode:e.colorMode,depthRange:[M,m],valueThreshold:f,background:e.background,showAxes:e.showAxes,showPlanes:e.showPlanes,cameraMode:e.cameraMode,sync:t,onVisibleCount:T=>l(T),onFrame:a})})}),Pe.jsx("div",{className:"pointer-events-none absolute left-1 top-1 z-10 mono rounded bg-bg/80 px-1 py-0.5 text-[10px] text-fg-subtle backdrop-blur-sm",children:`${(c??p.n_boxes).toLocaleString()} of ${p.n_boxes.toLocaleString()} boxes · ${p.kind}`}),Pe.jsx(Gr,{label:n,isDraggable:r,onDragStart:s})]})}const gg=400,_g=te.createContext(!1);function Hr({height:i,children:e}){const t=te.useContext(_g);return Pe.jsxs("div",{className:"cairn-plot-chartbox",style:{height:i??(t?"100%":gg),width:"100%"},children:[Pe.jsx("style",{children:".cairn-plot-chartbox > * { height: 100%; width: 100%; }"}),e]})}const xg={pointSize:2.5,pointSizeMode:"screen",colorMode:"auto",background:"dark",property:null,showAxes:!1,showPlanes:!1,cameraMode:"orbital"};function vg(i){const{height:e,item:t,...n}=i,r={...xg,...typeof n.pointSize=="number"?{pointSize:n.pointSize}:{},...n.pointSizeMode?{pointSizeMode:n.pointSizeMode}:{},...n.colorMode?{colorMode:n.colorMode}:{},...n.background?{background:n.background}:{},...n.property!==void 0?{property:n.property}:{},...n.showAxes!==void 0?{showAxes:n.showAxes}:{},...n.showPlanes!==void 0?{showPlanes:n.showPlanes}:{},...n.cameraMode?{cameraMode:n.cameraMode}:{}};return Pe.jsx(Hr,{height:e,children:Pe.jsx(Ym,{item:t??null,view:r,sync:null,label:n.label??""})})}const Mg={colorMode:"solid",shading:"smooth",wireframe:!1,doubleSided:!0,background:"dark",property:null,showAxes:!1,showPlanes:!1,cameraMode:"orbital"};function Sg(i){const{height:e,item:t,...n}=i,r={...Mg,...n.colorMode?{colorMode:n.colorMode}:{},...n.shading?{shading:n.shading}:{},...n.wireframe!==void 0?{wireframe:n.wireframe}:{},...n.doubleSided!==void 0?{doubleSided:n.doubleSided}:{},...n.background?{background:n.background}:{},...n.property!==void 0?{property:n.property}:{},...n.showAxes!==void 0?{showAxes:n.showAxes}:{},...n.showPlanes!==void 0?{showPlanes:n.showPlanes}:{},...n.cameraMode?{cameraMode:n.cameraMode}:{}};return Pe.jsx(Hr,{height:e,children:Pe.jsx(jm,{item:t??null,view:r,sync:null,label:n.label??""})})}const Eg={mode:"mip",isovalue:.5,colormap:"viridis",steps:128,clipMin:[0,0,0],clipMax:[1,1,1],background:"dark",showAxes:!1,showPlanes:!1,cameraMode:"orbital"};function yg(i){const{height:e,item:t,...n}=i,r={...Eg,...n.mode?{mode:n.mode}:{},...typeof n.isovalue=="number"?{isovalue:n.isovalue}:{},...n.colormap?{colormap:n.colormap}:{},...n.steps?{steps:n.steps}:{},...n.clipMin?{clipMin:n.clipMin}:{},...n.clipMax?{clipMax:n.clipMax}:{},...n.background?{background:n.background}:{},...n.showAxes!==void 0?{showAxes:n.showAxes}:{},...n.showPlanes!==void 0?{showPlanes:n.showPlanes}:{},...n.cameraMode?{cameraMode:n.cameraMode}:{}};return Pe.jsx(Hr,{height:e,children:Pe.jsx(cg,{item:t??null,view:r,sync:null,label:n.label??""})})}const bg={colorMode:"depth",background:"dark",property:null,showAxes:!1,showPlanes:!1,cameraMode:"orbital"};function Tg(i){const{height:e,item:t,...n}=i,r={...bg,...n.colorMode?{colorMode:n.colorMode}:{},...n.background?{background:n.background}:{},...n.property!==void 0?{property:n.property}:{},...n.showAxes!==void 0?{showAxes:n.showAxes}:{},...n.showPlanes!==void 0?{showPlanes:n.showPlanes}:{},...n.cameraMode?{cameraMode:n.cameraMode}:{},...typeof n.depthMin=="number"?{depthMin:n.depthMin}:{},...typeof n.depthMax=="number"?{depthMax:n.depthMax}:{}};return Pe.jsx(Hr,{height:e,children:Pe.jsx(mg,{item:t??null,view:r,sync:null,label:n.label??""})})}window.__cairnPlotThreeLoaded||(typeof window.__cairnPlotRegisterRenderer=="function"?(window.__cairnPlotRegisterRenderer("pointcloud",vg),window.__cairnPlotRegisterRenderer("mesh",Sg),window.__cairnPlotRegisterRenderer("volume",yg),window.__cairnPlotRegisterRenderer("boxes3d",Tg),window.__cairnPlotThreeLoaded=!0):console.error("cairn-plot three addon: core bundle not installed (window.__cairnPlotRegisterRenderer missing) — 3D plots will not render."))})(__cairnPlotJsxRuntime,__cairnPlotReact);
