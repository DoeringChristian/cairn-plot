/* @ts-self-types="./cairn_exr_decode.d.ts" */
...
export class DecodedImage {
     ...
     */
    get channels() {
        const ret = wasm.decodedimage_channels(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get floats() {
        const ret = wasm.decodedimage_floats(this.__wbg_ptr);
     ...
     */
    get halfBits() {
        const ret = wasm.decodedimage_halfBits(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {number}
    ...
    get precision() {
        ...
        try {
            ...
            wasm.decodedimage_precision(retptr, this.__wbg_ptr);
...
export function decode_exr(bytes) {
    try {
        ...
        wasm.decode_exr(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./cairn_exr_decode_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cairn_exr_decode_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
