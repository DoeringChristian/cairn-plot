...
em++ $CFLAGS_COMMON -std=c++17 \
  ...
  -sEXPORTED_FUNCTIONS='["_cairn_exr_decode","_cairn_exr_free","_cairn_exr_open_deep","_cairn_exr_flatten_deep","_cairn_exr_free_open_deep","_cairn_exr_free_deep","_cairn_exr_set_deep_budget","_malloc","_free"]' \
