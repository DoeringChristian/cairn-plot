 ...
 * RUNNING (manual):
 *   npx esbuild \
 *     src/plots/image/compare/__tests__/gpu-compare-split-numbers.browser.ts \
 *     --bundle --format=esm --jsx=automatic \
 *     --outfile=src/plots/image/compare/__tests__/gpu-compare-split-numbers.browser.bundle.js
...
import { urlSource, type CompareSource } from "../../backends/contracts";
