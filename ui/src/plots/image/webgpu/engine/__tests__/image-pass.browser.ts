 ...
 *          src/plots/image/webgpu/engine/__tests__/image-pass.browser.ts \
 *          --bundle --format=esm \
 *          --outfile=src/plots/image/webgpu/engine/__tests__/image-pass.browser.bundle.js
 *   2. Serve over http (file:// is blocked for module scripts):
 *        cd cairn/ui/src/plots/image/webgpu/engine/__tests__ && python3 -m http.server 8936
