 ...
 *          src/plots/image/webgpu/engine/__tests__/deep-composite.browser.ts \
 *          --bundle --format=esm \
 *          --outfile=src/plots/image/webgpu/engine/__tests__/deep-composite.browser.bundle.js
 ...
 *   3. Open http://localhost:8937/src/plots/image/webgpu/engine/__tests__/deep-composite.browser.html
