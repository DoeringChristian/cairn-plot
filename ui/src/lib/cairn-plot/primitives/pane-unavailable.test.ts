 ...
 *     src/lib/cairn-plot/primitives/pane-unavailable.test.ts
 *
...
const pane = read("primitives/PaneUnavailable.tsx");
...
const CONSUMERS = ["../../engines/three/VolumeViewer.tsx", "media-compare/compositor.tsx"];
