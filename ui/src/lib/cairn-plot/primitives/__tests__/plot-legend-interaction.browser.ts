 ...
 *        src/lib/cairn-plot/primitives/__tests__/plot-legend-interaction.browser.ts \
 *        --bundle --format=esm --tsconfig=tsconfig.app.json \
 *        --outfile=src/lib/cairn-plot/primitives/__tests__/plot-legend-interaction.browser.bundle.js
 *   2. Serve: cd cairn/ui/src/lib/cairn-plot/primitives/__tests__ && python3 -m http.server 8942
