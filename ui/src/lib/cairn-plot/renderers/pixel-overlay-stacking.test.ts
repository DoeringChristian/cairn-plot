 ...
 *     src/lib/cairn-plot/renderers/pixel-overlay-stacking.test.ts
 */
...
const compositor = read("media-compare/compositor.tsx");
const overlay = read("primitives/PixelValueOverlay.tsx");
