 ...
 *     src/settings/colormaps/sample.test.ts
 *
...
test("colormapColor('turbo', ...) returns the turbo endpoints + midpoint", () => {
  assert.equal(colormapColor("turbo", 0), "rgb(48,18,59)");
  assert.equal(colormapColor("turbo", 0.5), "rgb(164,252,60)");
