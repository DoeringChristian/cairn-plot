 ...
 *        src/testing/browser/renderers/gpu-image-pane.browser.ts \
 *        --bundle --format=esm --jsx=automatic \
 *        --outfile=src/testing/browser/renderers/gpu-image-pane.browser.bundle.js
 ...
 *        npx esbuild \
 *        src/testing/browser/renderers/gpu-image-addon-check.browser.ts \
 *        --bundle --format=esm --jsx=automatic \
 *        --outfile=src/testing/browser/renderers/gpu-image-addon-check.browser.bundle.js
 *   2. Serve: cd cairn/ui/src/testing/browser/renderers && python3 -m http.server 8937
