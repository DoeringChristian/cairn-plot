 ...
 * (`ui/src/plots/image/components/use-chart-controller.ts` for the SVG charts, plus Scalar/PC
 ...
 * `ui/src/plots/chart/use-chart-view.ts`'s `ChartCapabilities`, so a toolbar can
