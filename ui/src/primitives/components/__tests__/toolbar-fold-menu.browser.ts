 ...
 *        src/primitives/components/__tests__/toolbar-fold-menu.browser.ts \
 *        --bundle --format=esm --tsconfig=tsconfig.app.json \
 *        --outfile=src/primitives/components/__tests__/toolbar-fold-menu.browser.bundle.js
 *   2. Copy CSS: cp dist/plot-inline/style.css \
 *        src/primitives/components/__tests__/harness-style.css
 *   3. Serve: cd cairn/ui/src/primitives/components/__tests__ && python3 -m http.server 8941
