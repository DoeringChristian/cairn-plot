 ...
 *        src/primitives/components/__tests__/toolbar-dismiss.browser.ts \
 *        --bundle --format=esm --tsconfig=tsconfig.app.json \
 *        --outfile=src/primitives/components/__tests__/toolbar-dismiss.browser.bundle.js
 *   2. Serve: cd cairn/ui/src/primitives/components/__tests__ && python3 -m http.server 8943
