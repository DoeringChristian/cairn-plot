 ...
 *        src/host/hooks/__tests__/resettable-state.browser.ts \
 *        --bundle --format=esm --tsconfig=tsconfig.app.json \
 *        --outfile=src/host/hooks/__tests__/resettable-state.browser.bundle.js
 *   2. Serve: cd cairn/ui/src/host/hooks/__tests__ && python3 -m http.server 8944
